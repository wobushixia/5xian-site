...
let IconHighlightOff_Sharp = class IconHighlightOff_Sharp extends LitElement {
    render() {
...
IconHighlightOff_Sharp.styles = style;
IconHighlightOff_Sharp = __decorate([
    customElement('mdui-icon-highlight-off--sharp')
], IconHighlightOff_Sharp);
export { IconHighlightOff_Sharp };
