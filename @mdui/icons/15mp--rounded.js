...
let Icon15mp_Rounded = class Icon15mp_Rounded extends LitElement {
    render() {
...
Icon15mp_Rounded.styles = style;
Icon15mp_Rounded = __decorate([
    customElement('mdui-icon-15mp--rounded')
], Icon15mp_Rounded);
export { Icon15mp_Rounded };
