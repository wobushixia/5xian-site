...
let IconEmojiNature_Sharp = class IconEmojiNature_Sharp extends LitElement {
    render() {
...
IconEmojiNature_Sharp.styles = style;
IconEmojiNature_Sharp = __decorate([
    customElement('mdui-icon-emoji-nature--sharp')
], IconEmojiNature_Sharp);
export { IconEmojiNature_Sharp };
