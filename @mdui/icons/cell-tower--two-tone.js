...
let IconCellTower_TwoTone = class IconCellTower_TwoTone extends LitElement {
    render() {
...
IconCellTower_TwoTone.styles = style;
IconCellTower_TwoTone = __decorate([
    customElement('mdui-icon-cell-tower--two-tone')
], IconCellTower_TwoTone);
export { IconCellTower_TwoTone };
