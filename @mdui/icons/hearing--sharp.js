...
let IconHearing_Sharp = class IconHearing_Sharp extends LitElement {
    render() {
...
IconHearing_Sharp.styles = style;
IconHearing_Sharp = __decorate([
    customElement('mdui-icon-hearing--sharp')
], IconHearing_Sharp);
export { IconHearing_Sharp };
