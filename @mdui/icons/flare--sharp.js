...
let IconFlare_Sharp = class IconFlare_Sharp extends LitElement {
    render() {
...
IconFlare_Sharp.styles = style;
IconFlare_Sharp = __decorate([
    customElement('mdui-icon-flare--sharp')
], IconFlare_Sharp);
export { IconFlare_Sharp };
