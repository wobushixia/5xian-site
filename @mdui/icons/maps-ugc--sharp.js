...
let IconMapsUgc_Sharp = class IconMapsUgc_Sharp extends LitElement {
    render() {
...
IconMapsUgc_Sharp.styles = style;
IconMapsUgc_Sharp = __decorate([
    customElement('mdui-icon-maps-ugc--sharp')
], IconMapsUgc_Sharp);
export { IconMapsUgc_Sharp };
