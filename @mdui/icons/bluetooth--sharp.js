...
let IconBluetooth_Sharp = class IconBluetooth_Sharp extends LitElement {
    render() {
...
IconBluetooth_Sharp.styles = style;
IconBluetooth_Sharp = __decorate([
    customElement('mdui-icon-bluetooth--sharp')
], IconBluetooth_Sharp);
export { IconBluetooth_Sharp };
