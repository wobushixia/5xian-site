...
let IconInventory_Rounded = class IconInventory_Rounded extends LitElement {
    render() {
...
IconInventory_Rounded.styles = style;
IconInventory_Rounded = __decorate([
    customElement('mdui-icon-inventory--rounded')
], IconInventory_Rounded);
export { IconInventory_Rounded };
