...
let IconSkateboarding_Sharp = class IconSkateboarding_Sharp extends LitElement {
    render() {
...
IconSkateboarding_Sharp.styles = style;
IconSkateboarding_Sharp = __decorate([
    customElement('mdui-icon-skateboarding--sharp')
], IconSkateboarding_Sharp);
export { IconSkateboarding_Sharp };
