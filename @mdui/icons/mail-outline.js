...
let IconMailOutline = class IconMailOutline extends LitElement {
    render() {
...
IconMailOutline.styles = style;
IconMailOutline = __decorate([
    customElement('mdui-icon-mail-outline')
], IconMailOutline);
