...
let IconContactPhone = class IconContactPhone extends LitElement {
    render() {
...
IconContactPhone.styles = style;
IconContactPhone = __decorate([
    customElement('mdui-icon-contact-phone')
], IconContactPhone);
