...
let IconBikeScooter_Sharp = class IconBikeScooter_Sharp extends LitElement {
    render() {
...
IconBikeScooter_Sharp.styles = style;
IconBikeScooter_Sharp = __decorate([
    customElement('mdui-icon-bike-scooter--sharp')
], IconBikeScooter_Sharp);
export { IconBikeScooter_Sharp };
