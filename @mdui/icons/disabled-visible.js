...
let IconDisabledVisible = class IconDisabledVisible extends LitElement {
    render() {
...
IconDisabledVisible.styles = style;
IconDisabledVisible = __decorate([
    customElement('mdui-icon-disabled-visible')
], IconDisabledVisible);
export { IconDisabledVisible };
