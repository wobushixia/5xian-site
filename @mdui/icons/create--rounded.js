...
let IconCreate_Rounded = class IconCreate_Rounded extends LitElement {
    render() {
...
IconCreate_Rounded.styles = style;
IconCreate_Rounded = __decorate([
    customElement('mdui-icon-create--rounded')
], IconCreate_Rounded);
export { IconCreate_Rounded };
