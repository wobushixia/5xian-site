...
let IconContactless_Sharp = class IconContactless_Sharp extends LitElement {
    render() {
...
IconContactless_Sharp.styles = style;
IconContactless_Sharp = __decorate([
    customElement('mdui-icon-contactless--sharp')
], IconContactless_Sharp);
export { IconContactless_Sharp };
