...
let IconMotionPhotosAuto_TwoTone = class IconMotionPhotosAuto_TwoTone extends LitElement {
    render() {
...
IconMotionPhotosAuto_TwoTone.styles = style;
IconMotionPhotosAuto_TwoTone = __decorate([
    customElement('mdui-icon-motion-photos-auto--two-tone')
], IconMotionPhotosAuto_TwoTone);
export { IconMotionPhotosAuto_TwoTone };
