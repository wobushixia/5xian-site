...
let IconGpsOff_TwoTone = class IconGpsOff_TwoTone extends LitElement {
    render() {
...
IconGpsOff_TwoTone.styles = style;
IconGpsOff_TwoTone = __decorate([
    customElement('mdui-icon-gps-off--two-tone')
], IconGpsOff_TwoTone);
export { IconGpsOff_TwoTone };
