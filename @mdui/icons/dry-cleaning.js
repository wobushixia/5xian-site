...
let IconDryCleaning = class IconDryCleaning extends LitElement {
    render() {
...
IconDryCleaning.styles = style;
IconDryCleaning = __decorate([
    customElement('mdui-icon-dry-cleaning')
], IconDryCleaning);
export { IconDryCleaning };
