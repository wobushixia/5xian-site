...
let IconFilterDrama = class IconFilterDrama extends LitElement {
    render() {
...
IconFilterDrama.styles = style;
IconFilterDrama = __decorate([
    customElement('mdui-icon-filter-drama')
], IconFilterDrama);
