...
let IconNoiseAware = class IconNoiseAware extends LitElement {
    render() {
...
IconNoiseAware.styles = style;
IconNoiseAware = __decorate([
    customElement('mdui-icon-noise-aware')
], IconNoiseAware);
export { IconNoiseAware };
