...
let IconScreenRotation = class IconScreenRotation extends LitElement {
    render() {
...
IconScreenRotation.styles = style;
IconScreenRotation = __decorate([
    customElement('mdui-icon-screen-rotation')
], IconScreenRotation);
