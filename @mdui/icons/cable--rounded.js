...
let IconCable_Rounded = class IconCable_Rounded extends LitElement {
    render() {
...
IconCable_Rounded.styles = style;
IconCable_Rounded = __decorate([
    customElement('mdui-icon-cable--rounded')
], IconCable_Rounded);
export { IconCable_Rounded };
