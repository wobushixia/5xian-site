...
let IconNoiseControlOff_Sharp = class IconNoiseControlOff_Sharp extends LitElement {
    render() {
...
IconNoiseControlOff_Sharp.styles = style;
IconNoiseControlOff_Sharp = __decorate([
    customElement('mdui-icon-noise-control-off--sharp')
], IconNoiseControlOff_Sharp);
export { IconNoiseControlOff_Sharp };
