...
let IconDirectionsBoat = class IconDirectionsBoat extends LitElement {
    render() {
...
IconDirectionsBoat.styles = style;
IconDirectionsBoat = __decorate([
    customElement('mdui-icon-directions-boat')
], IconDirectionsBoat);
