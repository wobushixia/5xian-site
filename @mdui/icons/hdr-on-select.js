...
let IconHdrOnSelect = class IconHdrOnSelect extends LitElement {
    render() {
...
IconHdrOnSelect.styles = style;
IconHdrOnSelect = __decorate([
    customElement('mdui-icon-hdr-on-select')
], IconHdrOnSelect);
export { IconHdrOnSelect };
