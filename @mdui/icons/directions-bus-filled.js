...
let IconDirectionsBusFilled = class IconDirectionsBusFilled extends LitElement {
    render() {
...
IconDirectionsBusFilled.styles = style;
IconDirectionsBusFilled = __decorate([
    customElement('mdui-icon-directions-bus-filled')
], IconDirectionsBusFilled);
export { IconDirectionsBusFilled };
