...
let IconAttractions_Sharp = class IconAttractions_Sharp extends LitElement {
    render() {
...
IconAttractions_Sharp.styles = style;
IconAttractions_Sharp = __decorate([
    customElement('mdui-icon-attractions--sharp')
], IconAttractions_Sharp);
export { IconAttractions_Sharp };
