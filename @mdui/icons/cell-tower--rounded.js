...
let IconCellTower_Rounded = class IconCellTower_Rounded extends LitElement {
    render() {
...
IconCellTower_Rounded.styles = style;
IconCellTower_Rounded = __decorate([
    customElement('mdui-icon-cell-tower--rounded')
], IconCellTower_Rounded);
export { IconCellTower_Rounded };
