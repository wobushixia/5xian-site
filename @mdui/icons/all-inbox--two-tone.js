...
let IconAllInbox_TwoTone = class IconAllInbox_TwoTone extends LitElement {
    render() {
...
IconAllInbox_TwoTone.styles = style;
IconAllInbox_TwoTone = __decorate([
    customElement('mdui-icon-all-inbox--two-tone')
], IconAllInbox_TwoTone);
export { IconAllInbox_TwoTone };
