...
let IconMotionPhotosAuto = class IconMotionPhotosAuto extends LitElement {
    render() {
...
IconMotionPhotosAuto.styles = style;
IconMotionPhotosAuto = __decorate([
    customElement('mdui-icon-motion-photos-auto')
], IconMotionPhotosAuto);
export { IconMotionPhotosAuto };
