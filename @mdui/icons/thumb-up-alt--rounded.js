...
let IconThumbUpAlt_Rounded = class IconThumbUpAlt_Rounded extends LitElement {
    render() {
...
IconThumbUpAlt_Rounded.styles = style;
IconThumbUpAlt_Rounded = __decorate([
    customElement('mdui-icon-thumb-up-alt--rounded')
], IconThumbUpAlt_Rounded);
export { IconThumbUpAlt_Rounded };
