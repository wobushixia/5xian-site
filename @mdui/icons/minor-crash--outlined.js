...
let IconMinorCrash_Outlined = class IconMinorCrash_Outlined extends LitElement {
    render() {
...
IconMinorCrash_Outlined.styles = style;
IconMinorCrash_Outlined = __decorate([
    customElement('mdui-icon-minor-crash--outlined')
], IconMinorCrash_Outlined);
export { IconMinorCrash_Outlined };
