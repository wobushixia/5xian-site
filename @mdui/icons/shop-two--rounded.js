...
let IconShopTwo_Rounded = class IconShopTwo_Rounded extends LitElement {
    render() {
...
IconShopTwo_Rounded.styles = style;
IconShopTwo_Rounded = __decorate([
    customElement('mdui-icon-shop-two--rounded')
], IconShopTwo_Rounded);
export { IconShopTwo_Rounded };
