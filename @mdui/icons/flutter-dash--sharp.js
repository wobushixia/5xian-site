...
let IconFlutterDash_Sharp = class IconFlutterDash_Sharp extends LitElement {
    render() {
...
IconFlutterDash_Sharp.styles = style;
IconFlutterDash_Sharp = __decorate([
    customElement('mdui-icon-flutter-dash--sharp')
], IconFlutterDash_Sharp);
export { IconFlutterDash_Sharp };
