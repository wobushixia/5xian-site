...
let IconElectricBike_Rounded = class IconElectricBike_Rounded extends LitElement {
    render() {
...
IconElectricBike_Rounded.styles = style;
IconElectricBike_Rounded = __decorate([
    customElement('mdui-icon-electric-bike--rounded')
], IconElectricBike_Rounded);
export { IconElectricBike_Rounded };
