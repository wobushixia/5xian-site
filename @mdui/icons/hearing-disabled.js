...
let IconHearingDisabled = class IconHearingDisabled extends LitElement {
    render() {
...
IconHearingDisabled.styles = style;
IconHearingDisabled = __decorate([
    customElement('mdui-icon-hearing-disabled')
], IconHearingDisabled);
