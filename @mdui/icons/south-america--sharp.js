...
let IconSouthAmerica_Sharp = class IconSouthAmerica_Sharp extends LitElement {
    render() {
...
IconSouthAmerica_Sharp.styles = style;
IconSouthAmerica_Sharp = __decorate([
    customElement('mdui-icon-south-america--sharp')
], IconSouthAmerica_Sharp);
export { IconSouthAmerica_Sharp };
