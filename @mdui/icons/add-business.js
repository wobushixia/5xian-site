...
let IconAddBusiness = class IconAddBusiness extends LitElement {
    render() {
...
IconAddBusiness.styles = style;
IconAddBusiness = __decorate([
    customElement('mdui-icon-add-business')
], IconAddBusiness);
