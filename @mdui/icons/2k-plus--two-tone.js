...
let Icon2kPlus_TwoTone = class Icon2kPlus_TwoTone extends LitElement {
    render() {
...
Icon2kPlus_TwoTone.styles = style;
Icon2kPlus_TwoTone = __decorate([
    customElement('mdui-icon-2k-plus--two-tone')
], Icon2kPlus_TwoTone);
export { Icon2kPlus_TwoTone };
