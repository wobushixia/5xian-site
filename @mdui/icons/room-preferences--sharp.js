...
let IconRoomPreferences_Sharp = class IconRoomPreferences_Sharp extends LitElement {
    render() {
...
IconRoomPreferences_Sharp.styles = style;
IconRoomPreferences_Sharp = __decorate([
    customElement('mdui-icon-room-preferences--sharp')
], IconRoomPreferences_Sharp);
export { IconRoomPreferences_Sharp };
