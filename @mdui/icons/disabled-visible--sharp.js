...
let IconDisabledVisible_Sharp = class IconDisabledVisible_Sharp extends LitElement {
    render() {
...
IconDisabledVisible_Sharp.styles = style;
IconDisabledVisible_Sharp = __decorate([
    customElement('mdui-icon-disabled-visible--sharp')
], IconDisabledVisible_Sharp);
export { IconDisabledVisible_Sharp };
