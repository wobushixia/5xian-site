...
let IconFace_5_TwoTone = class IconFace_5_TwoTone extends LitElement {
    render() {
...
IconFace_5_TwoTone.styles = style;
IconFace_5_TwoTone = __decorate([
    customElement('mdui-icon-face-5--two-tone')
], IconFace_5_TwoTone);
export { IconFace_5_TwoTone };
