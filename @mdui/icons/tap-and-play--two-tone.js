...
let IconTapAndPlay_TwoTone = class IconTapAndPlay_TwoTone extends LitElement {
    render() {
...
IconTapAndPlay_TwoTone.styles = style;
IconTapAndPlay_TwoTone = __decorate([
    customElement('mdui-icon-tap-and-play--two-tone')
], IconTapAndPlay_TwoTone);
export { IconTapAndPlay_TwoTone };
