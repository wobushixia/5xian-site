...
let IconGpsOff_Sharp = class IconGpsOff_Sharp extends LitElement {
    render() {
...
IconGpsOff_Sharp.styles = style;
IconGpsOff_Sharp = __decorate([
    customElement('mdui-icon-gps-off--sharp')
], IconGpsOff_Sharp);
export { IconGpsOff_Sharp };
