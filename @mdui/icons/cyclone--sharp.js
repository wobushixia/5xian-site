...
let IconCyclone_Sharp = class IconCyclone_Sharp extends LitElement {
    render() {
...
IconCyclone_Sharp.styles = style;
IconCyclone_Sharp = __decorate([
    customElement('mdui-icon-cyclone--sharp')
], IconCyclone_Sharp);
export { IconCyclone_Sharp };
