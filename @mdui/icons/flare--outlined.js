...
let IconFlare_Outlined = class IconFlare_Outlined extends LitElement {
    render() {
...
IconFlare_Outlined.styles = style;
IconFlare_Outlined = __decorate([
    customElement('mdui-icon-flare--outlined')
], IconFlare_Outlined);
export { IconFlare_Outlined };
