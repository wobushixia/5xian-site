...
let IconSavedSearch_Sharp = class IconSavedSearch_Sharp extends LitElement {
    render() {
...
IconSavedSearch_Sharp.styles = style;
IconSavedSearch_Sharp = __decorate([
    customElement('mdui-icon-saved-search--sharp')
], IconSavedSearch_Sharp);
export { IconSavedSearch_Sharp };
