...
let IconInsights_Sharp = class IconInsights_Sharp extends LitElement {
    render() {
...
IconInsights_Sharp.styles = style;
IconInsights_Sharp = __decorate([
    customElement('mdui-icon-insights--sharp')
], IconInsights_Sharp);
export { IconInsights_Sharp };
