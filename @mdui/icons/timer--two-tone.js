...
let IconTimer_TwoTone = class IconTimer_TwoTone extends LitElement {
    render() {
...
IconTimer_TwoTone.styles = style;
IconTimer_TwoTone = __decorate([
    customElement('mdui-icon-timer--two-tone')
], IconTimer_TwoTone);
export { IconTimer_TwoTone };
