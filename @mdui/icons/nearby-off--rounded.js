...
let IconNearbyOff_Rounded = class IconNearbyOff_Rounded extends LitElement {
    render() {
...
IconNearbyOff_Rounded.styles = style;
IconNearbyOff_Rounded = __decorate([
    customElement('mdui-icon-nearby-off--rounded')
], IconNearbyOff_Rounded);
export { IconNearbyOff_Rounded };
