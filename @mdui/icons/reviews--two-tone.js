...
let IconReviews_TwoTone = class IconReviews_TwoTone extends LitElement {
    render() {
...
IconReviews_TwoTone.styles = style;
IconReviews_TwoTone = __decorate([
    customElement('mdui-icon-reviews--two-tone')
], IconReviews_TwoTone);
export { IconReviews_TwoTone };
