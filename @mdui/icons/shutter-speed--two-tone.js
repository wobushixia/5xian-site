...
let IconShutterSpeed_TwoTone = class IconShutterSpeed_TwoTone extends LitElement {
    render() {
...
IconShutterSpeed_TwoTone.styles = style;
IconShutterSpeed_TwoTone = __decorate([
    customElement('mdui-icon-shutter-speed--two-tone')
], IconShutterSpeed_TwoTone);
export { IconShutterSpeed_TwoTone };
