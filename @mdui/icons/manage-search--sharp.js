...
let IconManageSearch_Sharp = class IconManageSearch_Sharp extends LitElement {
    render() {
...
IconManageSearch_Sharp.styles = style;
IconManageSearch_Sharp = __decorate([
    customElement('mdui-icon-manage-search--sharp')
], IconManageSearch_Sharp);
export { IconManageSearch_Sharp };
