...
let IconRecycling_TwoTone = class IconRecycling_TwoTone extends LitElement {
    render() {
...
IconRecycling_TwoTone.styles = style;
IconRecycling_TwoTone = __decorate([
    customElement('mdui-icon-recycling--two-tone')
], IconRecycling_TwoTone);
export { IconRecycling_TwoTone };
