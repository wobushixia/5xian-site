...
let IconMotionPhotosPause_Sharp = class IconMotionPhotosPause_Sharp extends LitElement {
    render() {
...
IconMotionPhotosPause_Sharp.styles = style;
IconMotionPhotosPause_Sharp = __decorate([
    customElement('mdui-icon-motion-photos-pause--sharp')
], IconMotionPhotosPause_Sharp);
export { IconMotionPhotosPause_Sharp };
