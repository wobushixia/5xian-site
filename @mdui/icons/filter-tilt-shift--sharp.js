...
let IconFilterTiltShift_Sharp = class IconFilterTiltShift_Sharp extends LitElement {
    render() {
...
IconFilterTiltShift_Sharp.styles = style;
IconFilterTiltShift_Sharp = __decorate([
    customElement('mdui-icon-filter-tilt-shift--sharp')
], IconFilterTiltShift_Sharp);
export { IconFilterTiltShift_Sharp };
