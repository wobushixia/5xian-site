...
let IconSensorOccupied_Sharp = class IconSensorOccupied_Sharp extends LitElement {
    render() {
...
IconSensorOccupied_Sharp.styles = style;
IconSensorOccupied_Sharp = __decorate([
    customElement('mdui-icon-sensor-occupied--sharp')
], IconSensorOccupied_Sharp);
export { IconSensorOccupied_Sharp };
