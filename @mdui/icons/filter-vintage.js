...
let IconFilterVintage = class IconFilterVintage extends LitElement {
    render() {
...
IconFilterVintage.styles = style;
IconFilterVintage = __decorate([
    customElement('mdui-icon-filter-vintage')
], IconFilterVintage);
