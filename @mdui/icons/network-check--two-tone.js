...
let IconNetworkCheck_TwoTone = class IconNetworkCheck_TwoTone extends LitElement {
    render() {
...
IconNetworkCheck_TwoTone.styles = style;
IconNetworkCheck_TwoTone = __decorate([
    customElement('mdui-icon-network-check--two-tone')
], IconNetworkCheck_TwoTone);
export { IconNetworkCheck_TwoTone };
