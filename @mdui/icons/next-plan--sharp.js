...
let IconNextPlan_Sharp = class IconNextPlan_Sharp extends LitElement {
    render() {
...
IconNextPlan_Sharp.styles = style;
IconNextPlan_Sharp = __decorate([
    customElement('mdui-icon-next-plan--sharp')
], IconNextPlan_Sharp);
export { IconNextPlan_Sharp };
