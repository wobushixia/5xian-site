...
let IconFlipToBack_TwoTone = class IconFlipToBack_TwoTone extends LitElement {
    render() {
...
IconFlipToBack_TwoTone.styles = style;
IconFlipToBack_TwoTone = __decorate([
    customElement('mdui-icon-flip-to-back--two-tone')
], IconFlipToBack_TwoTone);
export { IconFlipToBack_TwoTone };
