...
let IconPresentToAll = class IconPresentToAll extends LitElement {
    render() {
...
IconPresentToAll.styles = style;
IconPresentToAll = __decorate([
    customElement('mdui-icon-present-to-all')
], IconPresentToAll);
