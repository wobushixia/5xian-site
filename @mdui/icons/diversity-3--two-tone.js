...
let IconDiversity_3_TwoTone = class IconDiversity_3_TwoTone extends LitElement {
    render() {
...
IconDiversity_3_TwoTone.styles = style;
IconDiversity_3_TwoTone = __decorate([
    customElement('mdui-icon-diversity-3--two-tone')
], IconDiversity_3_TwoTone);
export { IconDiversity_3_TwoTone };
