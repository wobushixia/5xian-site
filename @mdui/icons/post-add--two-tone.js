...
let IconPostAdd_TwoTone = class IconPostAdd_TwoTone extends LitElement {
    render() {
...
IconPostAdd_TwoTone.styles = style;
IconPostAdd_TwoTone = __decorate([
    customElement('mdui-icon-post-add--two-tone')
], IconPostAdd_TwoTone);
export { IconPostAdd_TwoTone };
