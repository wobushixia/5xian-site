...
let IconFingerprint_Sharp = class IconFingerprint_Sharp extends LitElement {
    render() {
...
IconFingerprint_Sharp.styles = style;
IconFingerprint_Sharp = __decorate([
    customElement('mdui-icon-fingerprint--sharp')
], IconFingerprint_Sharp);
export { IconFingerprint_Sharp };
