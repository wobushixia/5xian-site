...
let IconCloudCircle_Outlined = class IconCloudCircle_Outlined extends LitElement {
    render() {
...
IconCloudCircle_Outlined.styles = style;
IconCloudCircle_Outlined = __decorate([
    customElement('mdui-icon-cloud-circle--outlined')
], IconCloudCircle_Outlined);
export { IconCloudCircle_Outlined };
