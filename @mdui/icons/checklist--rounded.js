...
let IconChecklist_Rounded = class IconChecklist_Rounded extends LitElement {
    render() {
...
IconChecklist_Rounded.styles = style;
IconChecklist_Rounded = __decorate([
    customElement('mdui-icon-checklist--rounded')
], IconChecklist_Rounded);
export { IconChecklist_Rounded };
