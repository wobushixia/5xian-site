...
let IconPersonalInjury_Sharp = class IconPersonalInjury_Sharp extends LitElement {
    render() {
...
IconPersonalInjury_Sharp.styles = style;
IconPersonalInjury_Sharp = __decorate([
    customElement('mdui-icon-personal-injury--sharp')
], IconPersonalInjury_Sharp);
export { IconPersonalInjury_Sharp };
