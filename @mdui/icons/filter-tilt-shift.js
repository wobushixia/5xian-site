...
let IconFilterTiltShift = class IconFilterTiltShift extends LitElement {
    render() {
...
IconFilterTiltShift.styles = style;
IconFilterTiltShift = __decorate([
    customElement('mdui-icon-filter-tilt-shift')
], IconFilterTiltShift);
