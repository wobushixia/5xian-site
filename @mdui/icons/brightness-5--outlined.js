...
let IconBrightness_5_Outlined = class IconBrightness_5_Outlined extends LitElement {
    render() {
...
IconBrightness_5_Outlined.styles = style;
IconBrightness_5_Outlined = __decorate([
    customElement('mdui-icon-brightness-5--outlined')
], IconBrightness_5_Outlined);
export { IconBrightness_5_Outlined };
