...
let IconCameraswitch_Rounded = class IconCameraswitch_Rounded extends LitElement {
    render() {
...
IconCameraswitch_Rounded.styles = style;
IconCameraswitch_Rounded = __decorate([
    customElement('mdui-icon-cameraswitch--rounded')
], IconCameraswitch_Rounded);
export { IconCameraswitch_Rounded };
