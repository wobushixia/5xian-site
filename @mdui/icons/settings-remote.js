...
let IconSettingsRemote = class IconSettingsRemote extends LitElement {
    render() {
...
IconSettingsRemote.styles = style;
IconSettingsRemote = __decorate([
    customElement('mdui-icon-settings-remote')
], IconSettingsRemote);
