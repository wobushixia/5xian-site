...
let IconEarbudsBattery = class IconEarbudsBattery extends LitElement {
    render() {
...
IconEarbudsBattery.styles = style;
IconEarbudsBattery = __decorate([
    customElement('mdui-icon-earbuds-battery')
], IconEarbudsBattery);
