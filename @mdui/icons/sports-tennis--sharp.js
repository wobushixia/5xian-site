...
let IconSportsTennis_Sharp = class IconSportsTennis_Sharp extends LitElement {
    render() {
...
IconSportsTennis_Sharp.styles = style;
IconSportsTennis_Sharp = __decorate([
    customElement('mdui-icon-sports-tennis--sharp')
], IconSportsTennis_Sharp);
export { IconSportsTennis_Sharp };
