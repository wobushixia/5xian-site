...
let IconPermDataSetting_TwoTone = class IconPermDataSetting_TwoTone extends LitElement {
    render() {
...
IconPermDataSetting_TwoTone.styles = style;
IconPermDataSetting_TwoTone = __decorate([
    customElement('mdui-icon-perm-data-setting--two-tone')
], IconPermDataSetting_TwoTone);
export { IconPermDataSetting_TwoTone };
