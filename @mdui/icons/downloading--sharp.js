...
let IconDownloading_Sharp = class IconDownloading_Sharp extends LitElement {
    render() {
...
IconDownloading_Sharp.styles = style;
IconDownloading_Sharp = __decorate([
    customElement('mdui-icon-downloading--sharp')
], IconDownloading_Sharp);
export { IconDownloading_Sharp };
