...
let IconBook_TwoTone = class IconBook_TwoTone extends LitElement {
    render() {
...
IconBook_TwoTone.styles = style;
IconBook_TwoTone = __decorate([
    customElement('mdui-icon-book--two-tone')
], IconBook_TwoTone);
export { IconBook_TwoTone };
