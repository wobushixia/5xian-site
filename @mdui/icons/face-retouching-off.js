...
let IconFaceRetouchingOff = class IconFaceRetouchingOff extends LitElement {
    render() {
...
IconFaceRetouchingOff.styles = style;
IconFaceRetouchingOff = __decorate([
    customElement('mdui-icon-face-retouching-off')
], IconFaceRetouchingOff);
export { IconFaceRetouchingOff };
