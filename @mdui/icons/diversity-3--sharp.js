...
let IconDiversity_3_Sharp = class IconDiversity_3_Sharp extends LitElement {
    render() {
...
IconDiversity_3_Sharp.styles = style;
IconDiversity_3_Sharp = __decorate([
    customElement('mdui-icon-diversity-3--sharp')
], IconDiversity_3_Sharp);
export { IconDiversity_3_Sharp };
