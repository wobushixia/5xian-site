...
let IconPlagiarism_Outlined = class IconPlagiarism_Outlined extends LitElement {
    render() {
...
IconPlagiarism_Outlined.styles = style;
IconPlagiarism_Outlined = __decorate([
    customElement('mdui-icon-plagiarism--outlined')
], IconPlagiarism_Outlined);
export { IconPlagiarism_Outlined };
