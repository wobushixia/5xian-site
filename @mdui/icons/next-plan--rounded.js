...
let IconNextPlan_Rounded = class IconNextPlan_Rounded extends LitElement {
    render() {
...
IconNextPlan_Rounded.styles = style;
IconNextPlan_Rounded = __decorate([
    customElement('mdui-icon-next-plan--rounded')
], IconNextPlan_Rounded);
export { IconNextPlan_Rounded };
