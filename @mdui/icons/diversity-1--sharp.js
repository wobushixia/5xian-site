...
let IconDiversity_1_Sharp = class IconDiversity_1_Sharp extends LitElement {
    render() {
...
IconDiversity_1_Sharp.styles = style;
IconDiversity_1_Sharp = __decorate([
    customElement('mdui-icon-diversity-1--sharp')
], IconDiversity_1_Sharp);
export { IconDiversity_1_Sharp };
