...
let IconApi_TwoTone = class IconApi_TwoTone extends LitElement {
    render() {
...
IconApi_TwoTone.styles = style;
IconApi_TwoTone = __decorate([
    customElement('mdui-icon-api--two-tone')
], IconApi_TwoTone);
export { IconApi_TwoTone };
