...
let IconAdjust_Outlined = class IconAdjust_Outlined extends LitElement {
    render() {
...
IconAdjust_Outlined.styles = style;
IconAdjust_Outlined = __decorate([
    customElement('mdui-icon-adjust--outlined')
], IconAdjust_Outlined);
export { IconAdjust_Outlined };
