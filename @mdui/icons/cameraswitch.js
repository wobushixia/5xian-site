...
let IconCameraswitch = class IconCameraswitch extends LitElement {
    render() {
...
IconCameraswitch.styles = style;
IconCameraswitch = __decorate([
    customElement('mdui-icon-cameraswitch')
], IconCameraswitch);
