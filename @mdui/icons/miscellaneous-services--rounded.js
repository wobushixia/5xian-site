...
let IconMiscellaneousServices_Rounded = class IconMiscellaneousServices_Rounded extends LitElement {
    render() {
...
IconMiscellaneousServices_Rounded.styles = style;
IconMiscellaneousServices_Rounded = __decorate([
    customElement('mdui-icon-miscellaneous-services--rounded')
], IconMiscellaneousServices_Rounded);
export { IconMiscellaneousServices_Rounded };
