...
let IconCropOriginal = class IconCropOriginal extends LitElement {
    render() {
...
IconCropOriginal.styles = style;
IconCropOriginal = __decorate([
    customElement('mdui-icon-crop-original')
], IconCropOriginal);
