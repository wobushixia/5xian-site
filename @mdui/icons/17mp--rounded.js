...
let Icon17mp_Rounded = class Icon17mp_Rounded extends LitElement {
    render() {
...
Icon17mp_Rounded.styles = style;
Icon17mp_Rounded = __decorate([
    customElement('mdui-icon-17mp--rounded')
], Icon17mp_Rounded);
export { Icon17mp_Rounded };
