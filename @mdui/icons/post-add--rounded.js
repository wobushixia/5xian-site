...
let IconPostAdd_Rounded = class IconPostAdd_Rounded extends LitElement {
    render() {
...
IconPostAdd_Rounded.styles = style;
IconPostAdd_Rounded = __decorate([
    customElement('mdui-icon-post-add--rounded')
], IconPostAdd_Rounded);
export { IconPostAdd_Rounded };
