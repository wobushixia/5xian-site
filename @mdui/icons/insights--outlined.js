...
let IconInsights_Outlined = class IconInsights_Outlined extends LitElement {
    render() {
...
IconInsights_Outlined.styles = style;
IconInsights_Outlined = __decorate([
    customElement('mdui-icon-insights--outlined')
], IconInsights_Outlined);
export { IconInsights_Outlined };
