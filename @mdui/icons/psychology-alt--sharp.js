...
let IconPsychologyAlt_Sharp = class IconPsychologyAlt_Sharp extends LitElement {
    render() {
...
IconPsychologyAlt_Sharp.styles = style;
IconPsychologyAlt_Sharp = __decorate([
    customElement('mdui-icon-psychology-alt--sharp')
], IconPsychologyAlt_Sharp);
export { IconPsychologyAlt_Sharp };
