...
let Icon30fpsSelect_Outlined = class Icon30fpsSelect_Outlined extends LitElement {
    render() {
...
Icon30fpsSelect_Outlined.styles = style;
Icon30fpsSelect_Outlined = __decorate([
    customElement('mdui-icon-30fps-select--outlined')
], Icon30fpsSelect_Outlined);
export { Icon30fpsSelect_Outlined };
