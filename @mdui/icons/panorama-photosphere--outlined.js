...
let IconPanoramaPhotosphere_Outlined = class IconPanoramaPhotosphere_Outlined extends LitElement {
    render() {
...
IconPanoramaPhotosphere_Outlined.styles = style;
IconPanoramaPhotosphere_Outlined = __decorate([
    customElement('mdui-icon-panorama-photosphere--outlined')
], IconPanoramaPhotosphere_Outlined);
export { IconPanoramaPhotosphere_Outlined };
