...
let Icon3gMobiledata = class Icon3gMobiledata extends LitElement {
    render() {
...
Icon3gMobiledata.styles = style;
Icon3gMobiledata = __decorate([
    customElement('mdui-icon-3g-mobiledata')
], Icon3gMobiledata);
export { Icon3gMobiledata };
