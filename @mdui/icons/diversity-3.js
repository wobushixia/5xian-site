...
let IconDiversity_3 = class IconDiversity_3 extends LitElement {
    render() {
...
IconDiversity_3.styles = style;
IconDiversity_3 = __decorate([
    customElement('mdui-icon-diversity-3')
], IconDiversity_3);
export { IconDiversity_3 };
