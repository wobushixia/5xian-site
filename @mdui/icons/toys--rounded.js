...
let IconToys_Rounded = class IconToys_Rounded extends LitElement {
    render() {
...
IconToys_Rounded.styles = style;
IconToys_Rounded = __decorate([
    customElement('mdui-icon-toys--rounded')
], IconToys_Rounded);
export { IconToys_Rounded };
