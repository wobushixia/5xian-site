...
let IconSportsTennis = class IconSportsTennis extends LitElement {
    render() {
...
IconSportsTennis.styles = style;
IconSportsTennis = __decorate([
    customElement('mdui-icon-sports-tennis')
], IconSportsTennis);
