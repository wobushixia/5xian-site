...
let IconLockClock_Outlined = class IconLockClock_Outlined extends LitElement {
    render() {
...
IconLockClock_Outlined.styles = style;
IconLockClock_Outlined = __decorate([
    customElement('mdui-icon-lock-clock--outlined')
], IconLockClock_Outlined);
export { IconLockClock_Outlined };
