...
let IconSportsSoccer_Rounded = class IconSportsSoccer_Rounded extends LitElement {
    render() {
...
IconSportsSoccer_Rounded.styles = style;
IconSportsSoccer_Rounded = __decorate([
    customElement('mdui-icon-sports-soccer--rounded')
], IconSportsSoccer_Rounded);
export { IconSportsSoccer_Rounded };
