...
let Icon8mp_Outlined = class Icon8mp_Outlined extends LitElement {
    render() {
...
Icon8mp_Outlined.styles = style;
Icon8mp_Outlined = __decorate([
    customElement('mdui-icon-8mp--outlined')
], Icon8mp_Outlined);
export { Icon8mp_Outlined };
