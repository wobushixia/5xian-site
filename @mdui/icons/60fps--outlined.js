...
let Icon60fps_Outlined = class Icon60fps_Outlined extends LitElement {
    render() {
...
Icon60fps_Outlined.styles = style;
Icon60fps_Outlined = __decorate([
    customElement('mdui-icon-60fps--outlined')
], Icon60fps_Outlined);
export { Icon60fps_Outlined };
