...
let IconBrowserNotSupported = class IconBrowserNotSupported extends LitElement {
    render() {
...
IconBrowserNotSupported.styles = style;
IconBrowserNotSupported = __decorate([
    customElement('mdui-icon-browser-not-supported')
