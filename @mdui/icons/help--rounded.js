...
let IconHelp_Rounded = class IconHelp_Rounded extends LitElement {
    render() {
...
IconHelp_Rounded.styles = style;
IconHelp_Rounded = __decorate([
    customElement('mdui-icon-help--rounded')
], IconHelp_Rounded);
export { IconHelp_Rounded };
