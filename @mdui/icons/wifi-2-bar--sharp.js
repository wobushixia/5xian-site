...
let IconWifi_2Bar_Sharp = class IconWifi_2Bar_Sharp extends LitElement {
    render() {
...
IconWifi_2Bar_Sharp.styles = style;
IconWifi_2Bar_Sharp = __decorate([
    customElement('mdui-icon-wifi-2-bar--sharp')
], IconWifi_2Bar_Sharp);
export { IconWifi_2Bar_Sharp };
