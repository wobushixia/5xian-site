...
let IconEmojiNature = class IconEmojiNature extends LitElement {
    render() {
...
IconEmojiNature.styles = style;
IconEmojiNature = __decorate([
    customElement('mdui-icon-emoji-nature')
], IconEmojiNature);
export { IconEmojiNature };
