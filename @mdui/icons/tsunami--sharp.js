...
let IconTsunami_Sharp = class IconTsunami_Sharp extends LitElement {
    render() {
...
IconTsunami_Sharp.styles = style;
IconTsunami_Sharp = __decorate([
    customElement('mdui-icon-tsunami--sharp')
], IconTsunami_Sharp);
export { IconTsunami_Sharp };
