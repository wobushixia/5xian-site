...
let IconDisabledByDefault = class IconDisabledByDefault extends LitElement {
    render() {
...
IconDisabledByDefault.styles = style;
IconDisabledByDefault = __decorate([
    customElement('mdui-icon-disabled-by-default')
