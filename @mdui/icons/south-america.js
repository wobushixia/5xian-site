...
let IconSouthAmerica = class IconSouthAmerica extends LitElement {
    render() {
...
IconSouthAmerica.styles = style;
IconSouthAmerica = __decorate([
    customElement('mdui-icon-south-america')
], IconSouthAmerica);
export { IconSouthAmerica };
