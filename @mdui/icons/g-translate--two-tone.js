...
let IconGTranslate_TwoTone = class IconGTranslate_TwoTone extends LitElement {
    render() {
...
IconGTranslate_TwoTone.styles = style;
IconGTranslate_TwoTone = __decorate([
    customElement('mdui-icon-g-translate--two-tone')
], IconGTranslate_TwoTone);
export { IconGTranslate_TwoTone };
