...
let IconFiberNew_Rounded = class IconFiberNew_Rounded extends LitElement {
    render() {
...
IconFiberNew_Rounded.styles = style;
IconFiberNew_Rounded = __decorate([
    customElement('mdui-icon-fiber-new--rounded')
], IconFiberNew_Rounded);
export { IconFiberNew_Rounded };
