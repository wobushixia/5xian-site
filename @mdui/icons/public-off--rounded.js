...
let IconPublicOff_Rounded = class IconPublicOff_Rounded extends LitElement {
    render() {
...
IconPublicOff_Rounded.styles = style;
IconPublicOff_Rounded = __decorate([
    customElement('mdui-icon-public-off--rounded')
], IconPublicOff_Rounded);
export { IconPublicOff_Rounded };
