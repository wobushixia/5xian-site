...
let IconCloudOff_Sharp = class IconCloudOff_Sharp extends LitElement {
    render() {
...
IconCloudOff_Sharp.styles = style;
IconCloudOff_Sharp = __decorate([
    customElement('mdui-icon-cloud-off--sharp')
], IconCloudOff_Sharp);
export { IconCloudOff_Sharp };
