...
let IconHandshake_Rounded = class IconHandshake_Rounded extends LitElement {
    render() {
...
IconHandshake_Rounded.styles = style;
IconHandshake_Rounded = __decorate([
    customElement('mdui-icon-handshake--rounded')
], IconHandshake_Rounded);
export { IconHandshake_Rounded };
