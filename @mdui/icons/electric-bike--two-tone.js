...
let IconElectricBike_TwoTone = class IconElectricBike_TwoTone extends LitElement {
    render() {
...
IconElectricBike_TwoTone.styles = style;
IconElectricBike_TwoTone = __decorate([
    customElement('mdui-icon-electric-bike--two-tone')
], IconElectricBike_TwoTone);
export { IconElectricBike_TwoTone };
