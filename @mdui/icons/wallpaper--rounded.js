...
let IconWallpaper_Rounded = class IconWallpaper_Rounded extends LitElement {
    render() {
...
IconWallpaper_Rounded.styles = style;
IconWallpaper_Rounded = __decorate([
    customElement('mdui-icon-wallpaper--rounded')
], IconWallpaper_Rounded);
export { IconWallpaper_Rounded };
