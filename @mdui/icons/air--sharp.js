...
let IconAir_Sharp = class IconAir_Sharp extends LitElement {
    render() {
...
IconAir_Sharp.styles = style;
IconAir_Sharp = __decorate([
    customElement('mdui-icon-air--sharp')
], IconAir_Sharp);
export { IconAir_Sharp };
