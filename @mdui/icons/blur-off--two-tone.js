...
let IconBlurOff_TwoTone = class IconBlurOff_TwoTone extends LitElement {
    render() {
...
IconBlurOff_TwoTone.styles = style;
IconBlurOff_TwoTone = __decorate([
    customElement('mdui-icon-blur-off--two-tone')
], IconBlurOff_TwoTone);
export { IconBlurOff_TwoTone };
