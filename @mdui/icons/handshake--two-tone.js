...
let IconHandshake_TwoTone = class IconHandshake_TwoTone extends LitElement {
    render() {
...
IconHandshake_TwoTone.styles = style;
IconHandshake_TwoTone = __decorate([
    customElement('mdui-icon-handshake--two-tone')
], IconHandshake_TwoTone);
export { IconHandshake_TwoTone };
