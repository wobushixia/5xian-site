...
let IconSoap_Rounded = class IconSoap_Rounded extends LitElement {
    render() {
...
IconSoap_Rounded.styles = style;
IconSoap_Rounded = __decorate([
    customElement('mdui-icon-soap--rounded')
], IconSoap_Rounded);
export { IconSoap_Rounded };
