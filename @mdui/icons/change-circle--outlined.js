...
let IconChangeCircle_Outlined = class IconChangeCircle_Outlined extends LitElement {
    render() {
...
IconChangeCircle_Outlined.styles = style;
IconChangeCircle_Outlined = __decorate([
    customElement('mdui-icon-change-circle--outlined')
], IconChangeCircle_Outlined);
export { IconChangeCircle_Outlined };
