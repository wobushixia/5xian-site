...
let Icon9mp_Outlined = class Icon9mp_Outlined extends LitElement {
    render() {
...
Icon9mp_Outlined.styles = style;
Icon9mp_Outlined = __decorate([
    customElement('mdui-icon-9mp--outlined')
], Icon9mp_Outlined);
export { Icon9mp_Outlined };
