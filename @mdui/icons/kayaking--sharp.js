...
let IconKayaking_Sharp = class IconKayaking_Sharp extends LitElement {
    render() {
...
IconKayaking_Sharp.styles = style;
IconKayaking_Sharp = __decorate([
    customElement('mdui-icon-kayaking--sharp')
], IconKayaking_Sharp);
export { IconKayaking_Sharp };
