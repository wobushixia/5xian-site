...
let IconDirectionsBoat_Rounded = class IconDirectionsBoat_Rounded extends LitElement {
    render() {
...
IconDirectionsBoat_Rounded.styles = style;
IconDirectionsBoat_Rounded = __decorate([
    customElement('mdui-icon-directions-boat--rounded')
], IconDirectionsBoat_Rounded);
export { IconDirectionsBoat_Rounded };
