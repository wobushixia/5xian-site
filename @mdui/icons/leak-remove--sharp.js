...
let IconLeakRemove_Sharp = class IconLeakRemove_Sharp extends LitElement {
    render() {
...
IconLeakRemove_Sharp.styles = style;
IconLeakRemove_Sharp = __decorate([
    customElement('mdui-icon-leak-remove--sharp')
], IconLeakRemove_Sharp);
export { IconLeakRemove_Sharp };
