...
let IconSwitchAccessShortcut_TwoTone = class IconSwitchAccessShortcut_TwoTone extends LitElement {
    render() {
...
IconSwitchAccessShortcut_TwoTone.styles = style;
IconSwitchAccessShortcut_TwoTone = __decorate([
    customElement('mdui-icon-switch-access-shortcut--two-tone')
], IconSwitchAccessShortcut_TwoTone);
export { IconSwitchAccessShortcut_TwoTone };
