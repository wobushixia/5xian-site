...
let IconHotel_Rounded = class IconHotel_Rounded extends LitElement {
    render() {
...
IconHotel_Rounded.styles = style;
IconHotel_Rounded = __decorate([
    customElement('mdui-icon-hotel--rounded')
], IconHotel_Rounded);
export { IconHotel_Rounded };
