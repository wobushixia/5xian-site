...
let IconMotionPhotosPaused_TwoTone = class IconMotionPhotosPaused_TwoTone extends LitElement {
    render() {
...
IconMotionPhotosPaused_TwoTone.styles = style;
IconMotionPhotosPaused_TwoTone = __decorate([
    customElement('mdui-icon-motion-photos-paused--two-tone')
], IconMotionPhotosPaused_TwoTone);
export { IconMotionPhotosPaused_TwoTone };
