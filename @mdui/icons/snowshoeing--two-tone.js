...
let IconSnowshoeing_TwoTone = class IconSnowshoeing_TwoTone extends LitElement {
    render() {
...
IconSnowshoeing_TwoTone.styles = style;
IconSnowshoeing_TwoTone = __decorate([
    customElement('mdui-icon-snowshoeing--two-tone')
], IconSnowshoeing_TwoTone);
export { IconSnowshoeing_TwoTone };
