...
let IconBroadcastOnPersonal = class IconBroadcastOnPersonal extends LitElement {
    render() {
...
IconBroadcastOnPersonal.styles = style;
IconBroadcastOnPersonal = __decorate([
    customElement('mdui-icon-broadcast-on-personal')
