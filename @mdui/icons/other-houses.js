...
let IconOtherHouses = class IconOtherHouses extends LitElement {
    render() {
...
IconOtherHouses.styles = style;
IconOtherHouses = __decorate([
    customElement('mdui-icon-other-houses')
], IconOtherHouses);
