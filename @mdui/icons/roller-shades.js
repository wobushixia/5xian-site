...
let IconRollerShades = class IconRollerShades extends LitElement {
    render() {
...
IconRollerShades.styles = style;
IconRollerShades = __decorate([
    customElement('mdui-icon-roller-shades')
], IconRollerShades);
