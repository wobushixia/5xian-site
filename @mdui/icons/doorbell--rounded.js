...
let IconDoorbell_Rounded = class IconDoorbell_Rounded extends LitElement {
    render() {
...
IconDoorbell_Rounded.styles = style;
IconDoorbell_Rounded = __decorate([
    customElement('mdui-icon-doorbell--rounded')
], IconDoorbell_Rounded);
export { IconDoorbell_Rounded };
