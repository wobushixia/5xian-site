...
let IconAppSettingsAlt = class IconAppSettingsAlt extends LitElement {
    render() {
...
IconAppSettingsAlt.styles = style;
IconAppSettingsAlt = __decorate([
    customElement('mdui-icon-app-settings-alt')
], IconAppSettingsAlt);
