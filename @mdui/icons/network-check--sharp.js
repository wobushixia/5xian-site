...
let IconNetworkCheck_Sharp = class IconNetworkCheck_Sharp extends LitElement {
    render() {
...
IconNetworkCheck_Sharp.styles = style;
IconNetworkCheck_Sharp = __decorate([
    customElement('mdui-icon-network-check--sharp')
], IconNetworkCheck_Sharp);
export { IconNetworkCheck_Sharp };
