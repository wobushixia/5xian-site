...
let IconBorderStyle = class IconBorderStyle extends LitElement {
    render() {
...
IconBorderStyle.styles = style;
IconBorderStyle = __decorate([
    customElement('mdui-icon-border-style')
], IconBorderStyle);
