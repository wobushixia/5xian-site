...
let IconMotionPhotosAuto_Outlined = class IconMotionPhotosAuto_Outlined extends LitElement {
    render() {
...
IconMotionPhotosAuto_Outlined.styles = style;
IconMotionPhotosAuto_Outlined = __decorate([
    customElement('mdui-icon-motion-photos-auto--outlined')
], IconMotionPhotosAuto_Outlined);
export { IconMotionPhotosAuto_Outlined };
