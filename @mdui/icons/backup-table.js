...
let IconBackupTable = class IconBackupTable extends LitElement {
    render() {
...
IconBackupTable.styles = style;
IconBackupTable = __decorate([
    customElement('mdui-icon-backup-table')
], IconBackupTable);
