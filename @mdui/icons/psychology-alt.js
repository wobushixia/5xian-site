...
let IconPsychologyAlt = class IconPsychologyAlt extends LitElement {
    render() {
...
IconPsychologyAlt.styles = style;
IconPsychologyAlt = __decorate([
    customElement('mdui-icon-psychology-alt')
], IconPsychologyAlt);
export { IconPsychologyAlt };
