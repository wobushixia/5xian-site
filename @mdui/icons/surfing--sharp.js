...
let IconSurfing_Sharp = class IconSurfing_Sharp extends LitElement {
    render() {
...
IconSurfing_Sharp.styles = style;
IconSurfing_Sharp = __decorate([
    customElement('mdui-icon-surfing--sharp')
], IconSurfing_Sharp);
export { IconSurfing_Sharp };
