...
let IconPestControl = class IconPestControl extends LitElement {
    render() {
...
IconPestControl.styles = style;
IconPestControl = __decorate([
    customElement('mdui-icon-pest-control')
], IconPestControl);
