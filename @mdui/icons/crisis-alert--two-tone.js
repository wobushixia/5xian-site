...
let IconCrisisAlert_TwoTone = class IconCrisisAlert_TwoTone extends LitElement {
    render() {
...
IconCrisisAlert_TwoTone.styles = style;
IconCrisisAlert_TwoTone = __decorate([
    customElement('mdui-icon-crisis-alert--two-tone')
], IconCrisisAlert_TwoTone);
export { IconCrisisAlert_TwoTone };
