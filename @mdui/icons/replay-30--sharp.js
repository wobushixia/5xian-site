...
let IconReplay_30_Sharp = class IconReplay_30_Sharp extends LitElement {
    render() {
...
IconReplay_30_Sharp.styles = style;
IconReplay_30_Sharp = __decorate([
    customElement('mdui-icon-replay-30--sharp')
], IconReplay_30_Sharp);
export { IconReplay_30_Sharp };
