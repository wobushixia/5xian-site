...
let IconSentimentVeryDissatisfied_Sharp = class IconSentimentVeryDissatisfied_Sharp extends LitElement {
    render() {
...
IconSentimentVeryDissatisfied_Sharp.styles = style;
IconSentimentVeryDissatisfied_Sharp = __decorate([
    customElement('mdui-icon-sentiment-very-dissatisfied--sharp')
], IconSentimentVeryDissatisfied_Sharp);
export { IconSentimentVeryDissatisfied_Sharp };
