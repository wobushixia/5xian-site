...
let IconJoinInner = class IconJoinInner extends LitElement {
    render() {
...
IconJoinInner.styles = style;
IconJoinInner = __decorate([
    customElement('mdui-icon-join-inner')
], IconJoinInner);
export { IconJoinInner };
