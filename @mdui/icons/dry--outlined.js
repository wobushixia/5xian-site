...
let IconDry_Outlined = class IconDry_Outlined extends LitElement {
    render() {
...
IconDry_Outlined.styles = style;
IconDry_Outlined = __decorate([
    customElement('mdui-icon-dry--outlined')
], IconDry_Outlined);
export { IconDry_Outlined };
