...
let IconFaceRetouchingOff_Sharp = class IconFaceRetouchingOff_Sharp extends LitElement {
    render() {
...
IconFaceRetouchingOff_Sharp.styles = style;
IconFaceRetouchingOff_Sharp = __decorate([
    customElement('mdui-icon-face-retouching-off--sharp')
], IconFaceRetouchingOff_Sharp);
export { IconFaceRetouchingOff_Sharp };
