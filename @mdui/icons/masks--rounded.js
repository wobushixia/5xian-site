...
let IconMasks_Rounded = class IconMasks_Rounded extends LitElement {
    render() {
...
IconMasks_Rounded.styles = style;
IconMasks_Rounded = __decorate([
    customElement('mdui-icon-masks--rounded')
], IconMasks_Rounded);
export { IconMasks_Rounded };
