...
let IconRowing_Sharp = class IconRowing_Sharp extends LitElement {
    render() {
...
IconRowing_Sharp.styles = style;
IconRowing_Sharp = __decorate([
    customElement('mdui-icon-rowing--sharp')
], IconRowing_Sharp);
export { IconRowing_Sharp };
