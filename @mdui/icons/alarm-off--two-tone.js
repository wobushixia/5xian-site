...
let IconAlarmOff_TwoTone = class IconAlarmOff_TwoTone extends LitElement {
    render() {
...
IconAlarmOff_TwoTone.styles = style;
IconAlarmOff_TwoTone = __decorate([
    customElement('mdui-icon-alarm-off--two-tone')
], IconAlarmOff_TwoTone);
export { IconAlarmOff_TwoTone };
