...
let IconSupervisedUserCircle_Rounded = class IconSupervisedUserCircle_Rounded extends LitElement {
    render() {
...
IconSupervisedUserCircle_Rounded.styles = style;
IconSupervisedUserCircle_Rounded = __decorate([
    customElement('mdui-icon-supervised-user-circle--rounded')
], IconSupervisedUserCircle_Rounded);
export { IconSupervisedUserCircle_Rounded };
