...
let IconSportsTennis_Rounded = class IconSportsTennis_Rounded extends LitElement {
    render() {
...
IconSportsTennis_Rounded.styles = style;
IconSportsTennis_Rounded = __decorate([
    customElement('mdui-icon-sports-tennis--rounded')
], IconSportsTennis_Rounded);
export { IconSportsTennis_Rounded };
