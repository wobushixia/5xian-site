...
let IconSignLanguage = class IconSignLanguage extends LitElement {
    render() {
...
IconSignLanguage.styles = style;
IconSignLanguage = __decorate([
    customElement('mdui-icon-sign-language')
], IconSignLanguage);
export { IconSignLanguage };
