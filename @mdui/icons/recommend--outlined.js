...
let IconRecommend_Outlined = class IconRecommend_Outlined extends LitElement {
    render() {
...
IconRecommend_Outlined.styles = style;
IconRecommend_Outlined = __decorate([
    customElement('mdui-icon-recommend--outlined')
], IconRecommend_Outlined);
export { IconRecommend_Outlined };
