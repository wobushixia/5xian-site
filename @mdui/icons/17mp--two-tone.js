...
let Icon17mp_TwoTone = class Icon17mp_TwoTone extends LitElement {
    render() {
...
Icon17mp_TwoTone.styles = style;
Icon17mp_TwoTone = __decorate([
    customElement('mdui-icon-17mp--two-tone')
], Icon17mp_TwoTone);
export { Icon17mp_TwoTone };
