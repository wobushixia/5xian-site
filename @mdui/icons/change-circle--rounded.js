...
let IconChangeCircle_Rounded = class IconChangeCircle_Rounded extends LitElement {
    render() {
...
IconChangeCircle_Rounded.styles = style;
IconChangeCircle_Rounded = __decorate([
    customElement('mdui-icon-change-circle--rounded')
], IconChangeCircle_Rounded);
export { IconChangeCircle_Rounded };
