...
let IconFormatUnderlined = class IconFormatUnderlined extends LitElement {
    render() {
...
IconFormatUnderlined.styles = style;
IconFormatUnderlined = __decorate([
    customElement('mdui-icon-format-underlined')
