...
let IconHearing_Rounded = class IconHearing_Rounded extends LitElement {
    render() {
...
IconHearing_Rounded.styles = style;
IconHearing_Rounded = __decorate([
    customElement('mdui-icon-hearing--rounded')
], IconHearing_Rounded);
export { IconHearing_Rounded };
