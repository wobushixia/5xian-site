...
let IconContentCopy = class IconContentCopy extends LitElement {
    render() {
...
IconContentCopy.styles = style;
IconContentCopy = __decorate([
    customElement('mdui-icon-content-copy')
], IconContentCopy);
