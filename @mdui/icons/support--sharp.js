...
let IconSupport_Sharp = class IconSupport_Sharp extends LitElement {
    render() {
...
IconSupport_Sharp.styles = style;
IconSupport_Sharp = __decorate([
    customElement('mdui-icon-support--sharp')
], IconSupport_Sharp);
export { IconSupport_Sharp };
