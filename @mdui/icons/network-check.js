...
let IconNetworkCheck = class IconNetworkCheck extends LitElement {
    render() {
...
IconNetworkCheck.styles = style;
IconNetworkCheck = __decorate([
    customElement('mdui-icon-network-check')
], IconNetworkCheck);
