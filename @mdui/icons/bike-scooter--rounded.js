...
let IconBikeScooter_Rounded = class IconBikeScooter_Rounded extends LitElement {
    render() {
...
IconBikeScooter_Rounded.styles = style;
IconBikeScooter_Rounded = __decorate([
    customElement('mdui-icon-bike-scooter--rounded')
], IconBikeScooter_Rounded);
export { IconBikeScooter_Rounded };
