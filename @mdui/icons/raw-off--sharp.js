...
let IconRawOff_Sharp = class IconRawOff_Sharp extends LitElement {
    render() {
...
IconRawOff_Sharp.styles = style;
IconRawOff_Sharp = __decorate([
    customElement('mdui-icon-raw-off--sharp')
], IconRawOff_Sharp);
export { IconRawOff_Sharp };
