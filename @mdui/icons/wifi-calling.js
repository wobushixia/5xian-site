...
let IconWifiCalling = class IconWifiCalling extends LitElement {
    render() {
...
IconWifiCalling.styles = style;
IconWifiCalling = __decorate([
    customElement('mdui-icon-wifi-calling')
], IconWifiCalling);
