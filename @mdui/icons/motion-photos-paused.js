...
let IconMotionPhotosPaused = class IconMotionPhotosPaused extends LitElement {
    render() {
...
IconMotionPhotosPaused.styles = style;
IconMotionPhotosPaused = __decorate([
    customElement('mdui-icon-motion-photos-paused')
