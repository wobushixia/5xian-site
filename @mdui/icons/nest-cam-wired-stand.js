...
let IconNestCamWiredStand = class IconNestCamWiredStand extends LitElement {
    render() {
...
IconNestCamWiredStand.styles = style;
IconNestCamWiredStand = __decorate([
    customElement('mdui-icon-nest-cam-wired-stand')
], IconNestCamWiredStand);
export { IconNestCamWiredStand };
