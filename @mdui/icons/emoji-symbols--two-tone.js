...
let IconEmojiSymbols_TwoTone = class IconEmojiSymbols_TwoTone extends LitElement {
    render() {
...
IconEmojiSymbols_TwoTone.styles = style;
IconEmojiSymbols_TwoTone = __decorate([
    customElement('mdui-icon-emoji-symbols--two-tone')
], IconEmojiSymbols_TwoTone);
export { IconEmojiSymbols_TwoTone };
