...
let IconSoap_Sharp = class IconSoap_Sharp extends LitElement {
    render() {
...
IconSoap_Sharp.styles = style;
IconSoap_Sharp = __decorate([
    customElement('mdui-icon-soap--sharp')
], IconSoap_Sharp);
export { IconSoap_Sharp };
