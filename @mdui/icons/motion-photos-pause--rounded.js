...
let IconMotionPhotosPause_Rounded = class IconMotionPhotosPause_Rounded extends LitElement {
    render() {
...
IconMotionPhotosPause_Rounded.styles = style;
IconMotionPhotosPause_Rounded = __decorate([
    customElement('mdui-icon-motion-photos-pause--rounded')
], IconMotionPhotosPause_Rounded);
export { IconMotionPhotosPause_Rounded };
