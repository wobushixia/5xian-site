...
let IconPortableWifiOff_Sharp = class IconPortableWifiOff_Sharp extends LitElement {
    render() {
...
IconPortableWifiOff_Sharp.styles = style;
IconPortableWifiOff_Sharp = __decorate([
    customElement('mdui-icon-portable-wifi-off--sharp')
], IconPortableWifiOff_Sharp);
export { IconPortableWifiOff_Sharp };
