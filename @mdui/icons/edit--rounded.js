...
let IconEdit_Rounded = class IconEdit_Rounded extends LitElement {
    render() {
...
IconEdit_Rounded.styles = style;
IconEdit_Rounded = __decorate([
    customElement('mdui-icon-edit--rounded')
], IconEdit_Rounded);
export { IconEdit_Rounded };
