...
let IconOutdoorGrill = class IconOutdoorGrill extends LitElement {
    render() {
...
IconOutdoorGrill.styles = style;
IconOutdoorGrill = __decorate([
    customElement('mdui-icon-outdoor-grill')
], IconOutdoorGrill);
