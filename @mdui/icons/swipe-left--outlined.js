...
let IconSwipeLeft_Outlined = class IconSwipeLeft_Outlined extends LitElement {
    render() {
...
IconSwipeLeft_Outlined.styles = style;
IconSwipeLeft_Outlined = __decorate([
    customElement('mdui-icon-swipe-left--outlined')
], IconSwipeLeft_Outlined);
export { IconSwipeLeft_Outlined };
