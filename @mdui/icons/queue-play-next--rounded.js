...
let IconQueuePlayNext_Rounded = class IconQueuePlayNext_Rounded extends LitElement {
    render() {
...
IconQueuePlayNext_Rounded.styles = style;
IconQueuePlayNext_Rounded = __decorate([
    customElement('mdui-icon-queue-play-next--rounded')
], IconQueuePlayNext_Rounded);
export { IconQueuePlayNext_Rounded };
