...
let IconJoinFull_Rounded = class IconJoinFull_Rounded extends LitElement {
    render() {
...
IconJoinFull_Rounded.styles = style;
IconJoinFull_Rounded = __decorate([
    customElement('mdui-icon-join-full--rounded')
], IconJoinFull_Rounded);
export { IconJoinFull_Rounded };
