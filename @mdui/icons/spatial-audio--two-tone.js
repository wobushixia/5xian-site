...
let IconSpatialAudio_TwoTone = class IconSpatialAudio_TwoTone extends LitElement {
    render() {
...
IconSpatialAudio_TwoTone.styles = style;
IconSpatialAudio_TwoTone = __decorate([
    customElement('mdui-icon-spatial-audio--two-tone')
], IconSpatialAudio_TwoTone);
export { IconSpatialAudio_TwoTone };
