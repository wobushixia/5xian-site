...
let IconDiversity_2_Sharp = class IconDiversity_2_Sharp extends LitElement {
    render() {
...
IconDiversity_2_Sharp.styles = style;
IconDiversity_2_Sharp = __decorate([
    customElement('mdui-icon-diversity-2--sharp')
], IconDiversity_2_Sharp);
export { IconDiversity_2_Sharp };
