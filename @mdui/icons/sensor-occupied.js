...
let IconSensorOccupied = class IconSensorOccupied extends LitElement {
    render() {
...
IconSensorOccupied.styles = style;
IconSensorOccupied = __decorate([
    customElement('mdui-icon-sensor-occupied')
], IconSensorOccupied);
export { IconSensorOccupied };
