...
let IconCrisisAlert_Outlined = class IconCrisisAlert_Outlined extends LitElement {
    render() {
...
IconCrisisAlert_Outlined.styles = style;
IconCrisisAlert_Outlined = __decorate([
    customElement('mdui-icon-crisis-alert--outlined')
], IconCrisisAlert_Outlined);
export { IconCrisisAlert_Outlined };
