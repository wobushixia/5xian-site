...
let IconStreetview_Rounded = class IconStreetview_Rounded extends LitElement {
    render() {
...
IconStreetview_Rounded.styles = style;
IconStreetview_Rounded = __decorate([
    customElement('mdui-icon-streetview--rounded')
], IconStreetview_Rounded);
export { IconStreetview_Rounded };
