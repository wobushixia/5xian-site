...
let IconClose_Rounded = class IconClose_Rounded extends LitElement {
    render() {
...
IconClose_Rounded.styles = style;
IconClose_Rounded = __decorate([
    customElement('mdui-icon-close--rounded')
], IconClose_Rounded);
export { IconClose_Rounded };
