...
let IconNoiseControlOff = class IconNoiseControlOff extends LitElement {
    render() {
...
IconNoiseControlOff.styles = style;
IconNoiseControlOff = __decorate([
    customElement('mdui-icon-noise-control-off')
], IconNoiseControlOff);
export { IconNoiseControlOff };
