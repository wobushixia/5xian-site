...
let IconTapAndPlay_Outlined = class IconTapAndPlay_Outlined extends LitElement {
    render() {
...
IconTapAndPlay_Outlined.styles = style;
IconTapAndPlay_Outlined = __decorate([
    customElement('mdui-icon-tap-and-play--outlined')
], IconTapAndPlay_Outlined);
export { IconTapAndPlay_Outlined };
