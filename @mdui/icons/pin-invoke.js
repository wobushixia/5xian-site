...
let IconPinInvoke = class IconPinInvoke extends LitElement {
    render() {
...
IconPinInvoke.styles = style;
IconPinInvoke = __decorate([
    customElement('mdui-icon-pin-invoke')
], IconPinInvoke);
export { IconPinInvoke };
