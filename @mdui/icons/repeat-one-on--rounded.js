...
let IconRepeatOneOn_Rounded = class IconRepeatOneOn_Rounded extends LitElement {
    render() {
...
IconRepeatOneOn_Rounded.styles = style;
IconRepeatOneOn_Rounded = __decorate([
    customElement('mdui-icon-repeat-one-on--rounded')
], IconRepeatOneOn_Rounded);
export { IconRepeatOneOn_Rounded };
