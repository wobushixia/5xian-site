...
let IconJoinInner_Sharp = class IconJoinInner_Sharp extends LitElement {
    render() {
...
IconJoinInner_Sharp.styles = style;
IconJoinInner_Sharp = __decorate([
    customElement('mdui-icon-join-inner--sharp')
], IconJoinInner_Sharp);
export { IconJoinInner_Sharp };
