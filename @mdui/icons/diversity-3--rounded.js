...
let IconDiversity_3_Rounded = class IconDiversity_3_Rounded extends LitElement {
    render() {
...
IconDiversity_3_Rounded.styles = style;
IconDiversity_3_Rounded = __decorate([
    customElement('mdui-icon-diversity-3--rounded')
], IconDiversity_3_Rounded);
export { IconDiversity_3_Rounded };
