...
let IconEuro_Sharp = class IconEuro_Sharp extends LitElement {
    render() {
...
IconEuro_Sharp.styles = style;
IconEuro_Sharp = __decorate([
    customElement('mdui-icon-euro--sharp')
], IconEuro_Sharp);
export { IconEuro_Sharp };
