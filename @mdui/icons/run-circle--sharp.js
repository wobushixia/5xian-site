...
let IconRunCircle_Sharp = class IconRunCircle_Sharp extends LitElement {
    render() {
...
IconRunCircle_Sharp.styles = style;
IconRunCircle_Sharp = __decorate([
    customElement('mdui-icon-run-circle--sharp')
], IconRunCircle_Sharp);
export { IconRunCircle_Sharp };
