...
let IconSupport_Rounded = class IconSupport_Rounded extends LitElement {
    render() {
...
IconSupport_Rounded.styles = style;
IconSupport_Rounded = __decorate([
    customElement('mdui-icon-support--rounded')
], IconSupport_Rounded);
export { IconSupport_Rounded };
