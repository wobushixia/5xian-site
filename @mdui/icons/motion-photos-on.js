...
let IconMotionPhotosOn = class IconMotionPhotosOn extends LitElement {
    render() {
...
IconMotionPhotosOn.styles = style;
IconMotionPhotosOn = __decorate([
    customElement('mdui-icon-motion-photos-on')
], IconMotionPhotosOn);
