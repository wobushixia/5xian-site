...
let IconSportsRugby_Sharp = class IconSportsRugby_Sharp extends LitElement {
    render() {
...
IconSportsRugby_Sharp.styles = style;
IconSportsRugby_Sharp = __decorate([
    customElement('mdui-icon-sports-rugby--sharp')
], IconSportsRugby_Sharp);
export { IconSportsRugby_Sharp };
