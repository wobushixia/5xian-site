...
let IconStorm_Sharp = class IconStorm_Sharp extends LitElement {
    render() {
...
IconStorm_Sharp.styles = style;
IconStorm_Sharp = __decorate([
    customElement('mdui-icon-storm--sharp')
], IconStorm_Sharp);
export { IconStorm_Sharp };
