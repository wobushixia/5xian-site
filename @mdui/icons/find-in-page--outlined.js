...
let IconFindInPage_Outlined = class IconFindInPage_Outlined extends LitElement {
    render() {
...
IconFindInPage_Outlined.styles = style;
IconFindInPage_Outlined = __decorate([
    customElement('mdui-icon-find-in-page--outlined')
], IconFindInPage_Outlined);
export { IconFindInPage_Outlined };
