...
let IconEmojiNature_Rounded = class IconEmojiNature_Rounded extends LitElement {
    render() {
...
IconEmojiNature_Rounded.styles = style;
IconEmojiNature_Rounded = __decorate([
    customElement('mdui-icon-emoji-nature--rounded')
], IconEmojiNature_Rounded);
export { IconEmojiNature_Rounded };
