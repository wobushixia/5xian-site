...
let IconGroups_2_Sharp = class IconGroups_2_Sharp extends LitElement {
    render() {
...
IconGroups_2_Sharp.styles = style;
IconGroups_2_Sharp = __decorate([
    customElement('mdui-icon-groups-2--sharp')
], IconGroups_2_Sharp);
export { IconGroups_2_Sharp };
