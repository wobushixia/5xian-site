...
let IconWifiOff_TwoTone = class IconWifiOff_TwoTone extends LitElement {
    render() {
...
IconWifiOff_TwoTone.styles = style;
IconWifiOff_TwoTone = __decorate([
    customElement('mdui-icon-wifi-off--two-tone')
], IconWifiOff_TwoTone);
export { IconWifiOff_TwoTone };
