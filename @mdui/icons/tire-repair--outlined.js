...
let IconTireRepair_Outlined = class IconTireRepair_Outlined extends LitElement {
    render() {
...
IconTireRepair_Outlined.styles = style;
IconTireRepair_Outlined = __decorate([
    customElement('mdui-icon-tire-repair--outlined')
], IconTireRepair_Outlined);
export { IconTireRepair_Outlined };
