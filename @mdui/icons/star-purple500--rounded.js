...
let IconStarPurple500_Rounded = class IconStarPurple500_Rounded extends LitElement {
    render() {
...
IconStarPurple500_Rounded.styles = style;
IconStarPurple500_Rounded = __decorate([
    customElement('mdui-icon-star-purple500--rounded')
], IconStarPurple500_Rounded);
export { IconStarPurple500_Rounded };
