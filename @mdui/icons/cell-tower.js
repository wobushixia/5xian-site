...
let IconCellTower = class IconCellTower extends LitElement {
    render() {
...
IconCellTower.styles = style;
IconCellTower = __decorate([
    customElement('mdui-icon-cell-tower')
], IconCellTower);
export { IconCellTower };
