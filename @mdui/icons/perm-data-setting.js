...
let IconPermDataSetting = class IconPermDataSetting extends LitElement {
    render() {
...
IconPermDataSetting.styles = style;
IconPermDataSetting = __decorate([
    customElement('mdui-icon-perm-data-setting')
], IconPermDataSetting);
