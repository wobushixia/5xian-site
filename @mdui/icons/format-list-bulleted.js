...
let IconFormatListBulleted = class IconFormatListBulleted extends LitElement {
    render() {
...
IconFormatListBulleted.styles = style;
IconFormatListBulleted = __decorate([
    customElement('mdui-icon-format-list-bulleted')
