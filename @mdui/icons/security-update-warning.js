...
let IconSecurityUpdateWarning = class IconSecurityUpdateWarning extends LitElement {
    render() {
...
IconSecurityUpdateWarning.styles = style;
IconSecurityUpdateWarning = __decorate([
    customElement('mdui-icon-security-update-warning')
