...
let IconEscalatorWarning_TwoTone = class IconEscalatorWarning_TwoTone extends LitElement {
    render() {
...
IconEscalatorWarning_TwoTone.styles = style;
IconEscalatorWarning_TwoTone = __decorate([
    customElement('mdui-icon-escalator-warning--two-tone')
], IconEscalatorWarning_TwoTone);
export { IconEscalatorWarning_TwoTone };
