...
let IconAssistWalker = class IconAssistWalker extends LitElement {
    render() {
...
IconAssistWalker.styles = style;
IconAssistWalker = __decorate([
    customElement('mdui-icon-assist-walker')
], IconAssistWalker);
export { IconAssistWalker };
