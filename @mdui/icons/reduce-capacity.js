...
let IconReduceCapacity = class IconReduceCapacity extends LitElement {
    render() {
...
IconReduceCapacity.styles = style;
IconReduceCapacity = __decorate([
    customElement('mdui-icon-reduce-capacity')
], IconReduceCapacity);
