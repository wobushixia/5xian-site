...
let IconNoiseAware_Sharp = class IconNoiseAware_Sharp extends LitElement {
    render() {
...
IconNoiseAware_Sharp.styles = style;
IconNoiseAware_Sharp = __decorate([
    customElement('mdui-icon-noise-aware--sharp')
], IconNoiseAware_Sharp);
export { IconNoiseAware_Sharp };
