...
let IconMasks_Outlined = class IconMasks_Outlined extends LitElement {
    render() {
...
IconMasks_Outlined.styles = style;
IconMasks_Outlined = __decorate([
    customElement('mdui-icon-masks--outlined')
], IconMasks_Outlined);
export { IconMasks_Outlined };
