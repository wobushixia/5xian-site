...
let IconSwitchAccessShortcutAdd = class IconSwitchAccessShortcutAdd extends LitElement {
    render() {
...
IconSwitchAccessShortcutAdd.styles = style;
IconSwitchAccessShortcutAdd = __decorate([
    customElement('mdui-icon-switch-access-shortcut-add')
], IconSwitchAccessShortcutAdd);
export { IconSwitchAccessShortcutAdd };
