...
let IconSportsMotorsports = class IconSportsMotorsports extends LitElement {
    render() {
...
IconSportsMotorsports.styles = style;
IconSportsMotorsports = __decorate([
    customElement('mdui-icon-sports-motorsports')
