...
let IconMiscellaneousServices_TwoTone = class IconMiscellaneousServices_TwoTone extends LitElement {
    render() {
...
IconMiscellaneousServices_TwoTone.styles = style;
IconMiscellaneousServices_TwoTone = __decorate([
    customElement('mdui-icon-miscellaneous-services--two-tone')
], IconMiscellaneousServices_TwoTone);
export { IconMiscellaneousServices_TwoTone };
