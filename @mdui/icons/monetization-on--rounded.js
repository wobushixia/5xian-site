...
let IconMonetizationOn_Rounded = class IconMonetizationOn_Rounded extends LitElement {
    render() {
...
IconMonetizationOn_Rounded.styles = style;
IconMonetizationOn_Rounded = __decorate([
    customElement('mdui-icon-monetization-on--rounded')
], IconMonetizationOn_Rounded);
export { IconMonetizationOn_Rounded };
