...
let IconAutorenew_TwoTone = class IconAutorenew_TwoTone extends LitElement {
    render() {
...
IconAutorenew_TwoTone.styles = style;
IconAutorenew_TwoTone = __decorate([
    customElement('mdui-icon-autorenew--two-tone')
], IconAutorenew_TwoTone);
export { IconAutorenew_TwoTone };
