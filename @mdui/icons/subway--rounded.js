...
let IconSubway_Rounded = class IconSubway_Rounded extends LitElement {
    render() {
...
IconSubway_Rounded.styles = style;
IconSubway_Rounded = __decorate([
    customElement('mdui-icon-subway--rounded')
], IconSubway_Rounded);
export { IconSubway_Rounded };
