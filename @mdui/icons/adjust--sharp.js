...
let IconAdjust_Sharp = class IconAdjust_Sharp extends LitElement {
    render() {
...
IconAdjust_Sharp.styles = style;
IconAdjust_Sharp = __decorate([
    customElement('mdui-icon-adjust--sharp')
], IconAdjust_Sharp);
export { IconAdjust_Sharp };
