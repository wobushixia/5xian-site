...
let IconFitbit_Rounded = class IconFitbit_Rounded extends LitElement {
    render() {
...
IconFitbit_Rounded.styles = style;
IconFitbit_Rounded = __decorate([
    customElement('mdui-icon-fitbit--rounded')
], IconFitbit_Rounded);
export { IconFitbit_Rounded };
