...
let IconWatchOff_Sharp = class IconWatchOff_Sharp extends LitElement {
    render() {
...
IconWatchOff_Sharp.styles = style;
IconWatchOff_Sharp = __decorate([
    customElement('mdui-icon-watch-off--sharp')
], IconWatchOff_Sharp);
export { IconWatchOff_Sharp };
