...
let IconJoinRight = class IconJoinRight extends LitElement {
    render() {
...
IconJoinRight.styles = style;
IconJoinRight = __decorate([
    customElement('mdui-icon-join-right')
], IconJoinRight);
export { IconJoinRight };
