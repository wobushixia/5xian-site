...
let IconNetworkCheck_Rounded = class IconNetworkCheck_Rounded extends LitElement {
    render() {
...
IconNetworkCheck_Rounded.styles = style;
IconNetworkCheck_Rounded = __decorate([
    customElement('mdui-icon-network-check--rounded')
], IconNetworkCheck_Rounded);
export { IconNetworkCheck_Rounded };
