...
let IconAssistWalker_Rounded = class IconAssistWalker_Rounded extends LitElement {
    render() {
...
IconAssistWalker_Rounded.styles = style;
IconAssistWalker_Rounded = __decorate([
    customElement('mdui-icon-assist-walker--rounded')
], IconAssistWalker_Rounded);
export { IconAssistWalker_Rounded };
