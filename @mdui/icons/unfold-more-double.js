...
let IconUnfoldMoreDouble = class IconUnfoldMoreDouble extends LitElement {
    render() {
...
IconUnfoldMoreDouble.styles = style;
IconUnfoldMoreDouble = __decorate([
    customElement('mdui-icon-unfold-more-double')
], IconUnfoldMoreDouble);
export { IconUnfoldMoreDouble };
