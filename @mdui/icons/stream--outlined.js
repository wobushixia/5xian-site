...
let IconStream_Outlined = class IconStream_Outlined extends LitElement {
    render() {
...
IconStream_Outlined.styles = style;
IconStream_Outlined = __decorate([
    customElement('mdui-icon-stream--outlined')
], IconStream_Outlined);
export { IconStream_Outlined };
