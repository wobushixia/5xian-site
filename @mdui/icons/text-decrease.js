...
let IconTextDecrease = class IconTextDecrease extends LitElement {
    render() {
...
IconTextDecrease.styles = style;
IconTextDecrease = __decorate([
    customElement('mdui-icon-text-decrease')
], IconTextDecrease);
