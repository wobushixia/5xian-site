...
let IconPaid_Outlined = class IconPaid_Outlined extends LitElement {
    render() {
...
IconPaid_Outlined.styles = style;
IconPaid_Outlined = __decorate([
    customElement('mdui-icon-paid--outlined')
], IconPaid_Outlined);
export { IconPaid_Outlined };
