...
let IconOutdoorGrill_Rounded = class IconOutdoorGrill_Rounded extends LitElement {
    render() {
...
IconOutdoorGrill_Rounded.styles = style;
IconOutdoorGrill_Rounded = __decorate([
    customElement('mdui-icon-outdoor-grill--rounded')
], IconOutdoorGrill_Rounded);
export { IconOutdoorGrill_Rounded };
