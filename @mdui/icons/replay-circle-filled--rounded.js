...
let IconReplayCircleFilled_Rounded = class IconReplayCircleFilled_Rounded extends LitElement {
    render() {
...
IconReplayCircleFilled_Rounded.styles = style;
IconReplayCircleFilled_Rounded = __decorate([
    customElement('mdui-icon-replay-circle-filled--rounded')
], IconReplayCircleFilled_Rounded);
export { IconReplayCircleFilled_Rounded };
