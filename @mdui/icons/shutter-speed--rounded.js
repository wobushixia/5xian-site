...
let IconShutterSpeed_Rounded = class IconShutterSpeed_Rounded extends LitElement {
    render() {
...
IconShutterSpeed_Rounded.styles = style;
IconShutterSpeed_Rounded = __decorate([
    customElement('mdui-icon-shutter-speed--rounded')
], IconShutterSpeed_Rounded);
export { IconShutterSpeed_Rounded };
