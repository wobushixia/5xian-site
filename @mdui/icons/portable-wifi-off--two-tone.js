...
let IconPortableWifiOff_TwoTone = class IconPortableWifiOff_TwoTone extends LitElement {
    render() {
...
IconPortableWifiOff_TwoTone.styles = style;
IconPortableWifiOff_TwoTone = __decorate([
    customElement('mdui-icon-portable-wifi-off--two-tone')
], IconPortableWifiOff_TwoTone);
export { IconPortableWifiOff_TwoTone };
