...
let IconManageHistory = class IconManageHistory extends LitElement {
    render() {
...
IconManageHistory.styles = style;
IconManageHistory = __decorate([
    customElement('mdui-icon-manage-history')
], IconManageHistory);
export { IconManageHistory };
