...
let IconChangeCircle_Sharp = class IconChangeCircle_Sharp extends LitElement {
    render() {
...
IconChangeCircle_Sharp.styles = style;
IconChangeCircle_Sharp = __decorate([
    customElement('mdui-icon-change-circle--sharp')
], IconChangeCircle_Sharp);
export { IconChangeCircle_Sharp };
