...
let IconInsights_TwoTone = class IconInsights_TwoTone extends LitElement {
    render() {
...
IconInsights_TwoTone.styles = style;
IconInsights_TwoTone = __decorate([
    customElement('mdui-icon-insights--two-tone')
], IconInsights_TwoTone);
export { IconInsights_TwoTone };
