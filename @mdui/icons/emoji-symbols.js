...
let IconEmojiSymbols = class IconEmojiSymbols extends LitElement {
    render() {
...
IconEmojiSymbols.styles = style;
IconEmojiSymbols = __decorate([
    customElement('mdui-icon-emoji-symbols')
], IconEmojiSymbols);
