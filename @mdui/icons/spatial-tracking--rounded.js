...
let IconSpatialTracking_Rounded = class IconSpatialTracking_Rounded extends LitElement {
    render() {
...
IconSpatialTracking_Rounded.styles = style;
IconSpatialTracking_Rounded = __decorate([
    customElement('mdui-icon-spatial-tracking--rounded')
], IconSpatialTracking_Rounded);
export { IconSpatialTracking_Rounded };
