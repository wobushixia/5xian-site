...
let IconSpatialTracking_Sharp = class IconSpatialTracking_Sharp extends LitElement {
    render() {
...
IconSpatialTracking_Sharp.styles = style;
IconSpatialTracking_Sharp = __decorate([
    customElement('mdui-icon-spatial-tracking--sharp')
], IconSpatialTracking_Sharp);
export { IconSpatialTracking_Sharp };
