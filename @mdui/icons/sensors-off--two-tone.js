...
let IconSensorsOff_TwoTone = class IconSensorsOff_TwoTone extends LitElement {
    render() {
...
IconSensorsOff_TwoTone.styles = style;
IconSensorsOff_TwoTone = __decorate([
    customElement('mdui-icon-sensors-off--two-tone')
], IconSensorsOff_TwoTone);
export { IconSensorsOff_TwoTone };
