...
let Icon18mp_Outlined = class Icon18mp_Outlined extends LitElement {
    render() {
...
Icon18mp_Outlined.styles = style;
Icon18mp_Outlined = __decorate([
    customElement('mdui-icon-18mp--outlined')
], Icon18mp_Outlined);
export { Icon18mp_Outlined };
