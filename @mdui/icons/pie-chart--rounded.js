...
let IconPieChart_Rounded = class IconPieChart_Rounded extends LitElement {
    render() {
...
IconPieChart_Rounded.styles = style;
IconPieChart_Rounded = __decorate([
    customElement('mdui-icon-pie-chart--rounded')
], IconPieChart_Rounded);
export { IconPieChart_Rounded };
