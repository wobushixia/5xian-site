...
let IconGroups_2_Outlined = class IconGroups_2_Outlined extends LitElement {
    render() {
...
IconGroups_2_Outlined.styles = style;
IconGroups_2_Outlined = __decorate([
    customElement('mdui-icon-groups-2--outlined')
], IconGroups_2_Outlined);
export { IconGroups_2_Outlined };
