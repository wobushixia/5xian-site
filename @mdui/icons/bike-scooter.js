...
let IconBikeScooter = class IconBikeScooter extends LitElement {
    render() {
...
IconBikeScooter.styles = style;
IconBikeScooter = __decorate([
    customElement('mdui-icon-bike-scooter')
], IconBikeScooter);
