...
let IconLightbulbCircle_Outlined = class IconLightbulbCircle_Outlined extends LitElement {
    render() {
...
IconLightbulbCircle_Outlined.styles = style;
IconLightbulbCircle_Outlined = __decorate([
    customElement('mdui-icon-lightbulb-circle--outlined')
], IconLightbulbCircle_Outlined);
export { IconLightbulbCircle_Outlined };
