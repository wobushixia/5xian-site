...
let IconCommute_Rounded = class IconCommute_Rounded extends LitElement {
    render() {
...
IconCommute_Rounded.styles = style;
IconCommute_Rounded = __decorate([
    customElement('mdui-icon-commute--rounded')
], IconCommute_Rounded);
export { IconCommute_Rounded };
