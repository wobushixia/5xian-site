...
let IconSick_TwoTone = class IconSick_TwoTone extends LitElement {
    render() {
...
IconSick_TwoTone.styles = style;
IconSick_TwoTone = __decorate([
    customElement('mdui-icon-sick--two-tone')
], IconSick_TwoTone);
export { IconSick_TwoTone };
