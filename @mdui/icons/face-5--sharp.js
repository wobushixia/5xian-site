...
let IconFace_5_Sharp = class IconFace_5_Sharp extends LitElement {
    render() {
...
IconFace_5_Sharp.styles = style;
IconFace_5_Sharp = __decorate([
    customElement('mdui-icon-face-5--sharp')
], IconFace_5_Sharp);
export { IconFace_5_Sharp };
