...
let IconDriveEta_Rounded = class IconDriveEta_Rounded extends LitElement {
    render() {
...
IconDriveEta_Rounded.styles = style;
IconDriveEta_Rounded = __decorate([
    customElement('mdui-icon-drive-eta--rounded')
], IconDriveEta_Rounded);
export { IconDriveEta_Rounded };
