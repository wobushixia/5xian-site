...
let IconPerson_3_Outlined = class IconPerson_3_Outlined extends LitElement {
    render() {
...
IconPerson_3_Outlined.styles = style;
IconPerson_3_Outlined = __decorate([
    customElement('mdui-icon-person-3--outlined')
], IconPerson_3_Outlined);
export { IconPerson_3_Outlined };
