...
let IconKey_TwoTone = class IconKey_TwoTone extends LitElement {
    render() {
...
IconKey_TwoTone.styles = style;
IconKey_TwoTone = __decorate([
    customElement('mdui-icon-key--two-tone')
], IconKey_TwoTone);
export { IconKey_TwoTone };
