...
let IconFence_Sharp = class IconFence_Sharp extends LitElement {
    render() {
...
IconFence_Sharp.styles = style;
IconFence_Sharp = __decorate([
    customElement('mdui-icon-fence--sharp')
], IconFence_Sharp);
export { IconFence_Sharp };
