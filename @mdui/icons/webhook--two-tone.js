...
let IconWebhook_TwoTone = class IconWebhook_TwoTone extends LitElement {
    render() {
...
IconWebhook_TwoTone.styles = style;
IconWebhook_TwoTone = __decorate([
    customElement('mdui-icon-webhook--two-tone')
], IconWebhook_TwoTone);
export { IconWebhook_TwoTone };
