...
let IconHdrOffSelect_TwoTone = class IconHdrOffSelect_TwoTone extends LitElement {
    render() {
...
IconHdrOffSelect_TwoTone.styles = style;
IconHdrOffSelect_TwoTone = __decorate([
    customElement('mdui-icon-hdr-off-select--two-tone')
], IconHdrOffSelect_TwoTone);
export { IconHdrOffSelect_TwoTone };
