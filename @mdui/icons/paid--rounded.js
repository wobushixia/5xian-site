...
let IconPaid_Rounded = class IconPaid_Rounded extends LitElement {
    render() {
...
IconPaid_Rounded.styles = style;
IconPaid_Rounded = __decorate([
    customElement('mdui-icon-paid--rounded')
], IconPaid_Rounded);
export { IconPaid_Rounded };
