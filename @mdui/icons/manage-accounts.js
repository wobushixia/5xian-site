...
let IconManageAccounts = class IconManageAccounts extends LitElement {
    render() {
...
IconManageAccounts.styles = style;
IconManageAccounts = __decorate([
    customElement('mdui-icon-manage-accounts')
], IconManageAccounts);
