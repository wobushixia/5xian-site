...
let IconRailwayAlert_Outlined = class IconRailwayAlert_Outlined extends LitElement {
    render() {
...
IconRailwayAlert_Outlined.styles = style;
IconRailwayAlert_Outlined = __decorate([
    customElement('mdui-icon-railway-alert--outlined')
], IconRailwayAlert_Outlined);
export { IconRailwayAlert_Outlined };
