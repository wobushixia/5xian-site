...
let IconPedalBike_Rounded = class IconPedalBike_Rounded extends LitElement {
    render() {
...
IconPedalBike_Rounded.styles = style;
IconPedalBike_Rounded = __decorate([
    customElement('mdui-icon-pedal-bike--rounded')
], IconPedalBike_Rounded);
export { IconPedalBike_Rounded };
