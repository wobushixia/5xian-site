...
let IconContentCut_Rounded = class IconContentCut_Rounded extends LitElement {
    render() {
...
IconContentCut_Rounded.styles = style;
IconContentCut_Rounded = __decorate([
    customElement('mdui-icon-content-cut--rounded')
], IconContentCut_Rounded);
export { IconContentCut_Rounded };
