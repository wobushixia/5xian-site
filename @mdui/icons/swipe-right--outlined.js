...
let IconSwipeRight_Outlined = class IconSwipeRight_Outlined extends LitElement {
    render() {
...
IconSwipeRight_Outlined.styles = style;
IconSwipeRight_Outlined = __decorate([
    customElement('mdui-icon-swipe-right--outlined')
], IconSwipeRight_Outlined);
export { IconSwipeRight_Outlined };
