...
let IconJoinRight_Sharp = class IconJoinRight_Sharp extends LitElement {
    render() {
...
IconJoinRight_Sharp.styles = style;
IconJoinRight_Sharp = __decorate([
    customElement('mdui-icon-join-right--sharp')
], IconJoinRight_Sharp);
export { IconJoinRight_Sharp };
