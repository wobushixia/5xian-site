...
let IconCellTower_Sharp = class IconCellTower_Sharp extends LitElement {
    render() {
...
IconCellTower_Sharp.styles = style;
IconCellTower_Sharp = __decorate([
    customElement('mdui-icon-cell-tower--sharp')
], IconCellTower_Sharp);
export { IconCellTower_Sharp };
