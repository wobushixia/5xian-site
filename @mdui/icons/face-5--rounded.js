...
let IconFace_5_Rounded = class IconFace_5_Rounded extends LitElement {
    render() {
...
IconFace_5_Rounded.styles = style;
IconFace_5_Rounded = __decorate([
    customElement('mdui-icon-face-5--rounded')
], IconFace_5_Rounded);
export { IconFace_5_Rounded };
