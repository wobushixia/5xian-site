...
let IconFlipToBack_Outlined = class IconFlipToBack_Outlined extends LitElement {
    render() {
...
IconFlipToBack_Outlined.styles = style;
IconFlipToBack_Outlined = __decorate([
    customElement('mdui-icon-flip-to-back--outlined')
], IconFlipToBack_Outlined);
export { IconFlipToBack_Outlined };
