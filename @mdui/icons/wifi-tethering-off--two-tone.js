...
let IconWifiTetheringOff_TwoTone = class IconWifiTetheringOff_TwoTone extends LitElement {
    render() {
...
IconWifiTetheringOff_TwoTone.styles = style;
IconWifiTetheringOff_TwoTone = __decorate([
    customElement('mdui-icon-wifi-tethering-off--two-tone')
], IconWifiTetheringOff_TwoTone);
export { IconWifiTetheringOff_TwoTone };
