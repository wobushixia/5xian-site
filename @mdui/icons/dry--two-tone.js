...
let IconDry_TwoTone = class IconDry_TwoTone extends LitElement {
    render() {
...
IconDry_TwoTone.styles = style;
IconDry_TwoTone = __decorate([
    customElement('mdui-icon-dry--two-tone')
], IconDry_TwoTone);
export { IconDry_TwoTone };
