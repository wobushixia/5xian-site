...
let IconRecycling = class IconRecycling extends LitElement {
    render() {
...
IconRecycling.styles = style;
IconRecycling = __decorate([
    customElement('mdui-icon-recycling')
], IconRecycling);
export { IconRecycling };
