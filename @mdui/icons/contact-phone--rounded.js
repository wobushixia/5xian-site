...
let IconContactPhone_Rounded = class IconContactPhone_Rounded extends LitElement {
    render() {
...
IconContactPhone_Rounded.styles = style;
IconContactPhone_Rounded = __decorate([
    customElement('mdui-icon-contact-phone--rounded')
], IconContactPhone_Rounded);
export { IconContactPhone_Rounded };
