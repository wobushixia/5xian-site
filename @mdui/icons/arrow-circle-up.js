...
let IconArrowCircleUp = class IconArrowCircleUp extends LitElement {
    render() {
...
IconArrowCircleUp.styles = style;
IconArrowCircleUp = __decorate([
    customElement('mdui-icon-arrow-circle-up')
], IconArrowCircleUp);
