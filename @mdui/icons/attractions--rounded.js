...
let IconAttractions_Rounded = class IconAttractions_Rounded extends LitElement {
    render() {
...
IconAttractions_Rounded.styles = style;
IconAttractions_Rounded = __decorate([
    customElement('mdui-icon-attractions--rounded')
], IconAttractions_Rounded);
export { IconAttractions_Rounded };
