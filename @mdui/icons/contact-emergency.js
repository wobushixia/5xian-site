...
let IconContactEmergency = class IconContactEmergency extends LitElement {
    render() {
...
IconContactEmergency.styles = style;
IconContactEmergency = __decorate([
    customElement('mdui-icon-contact-emergency')
], IconContactEmergency);
export { IconContactEmergency };
