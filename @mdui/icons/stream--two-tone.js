...
let IconStream_TwoTone = class IconStream_TwoTone extends LitElement {
    render() {
...
IconStream_TwoTone.styles = style;
IconStream_TwoTone = __decorate([
    customElement('mdui-icon-stream--two-tone')
], IconStream_TwoTone);
export { IconStream_TwoTone };
