...
let IconLiquor_Outlined = class IconLiquor_Outlined extends LitElement {
    render() {
...
IconLiquor_Outlined.styles = style;
IconLiquor_Outlined = __decorate([
    customElement('mdui-icon-liquor--outlined')
], IconLiquor_Outlined);
export { IconLiquor_Outlined };
