...
let IconTableView_Outlined = class IconTableView_Outlined extends LitElement {
    render() {
...
IconTableView_Outlined.styles = style;
IconTableView_Outlined = __decorate([
    customElement('mdui-icon-table-view--outlined')
], IconTableView_Outlined);
export { IconTableView_Outlined };
