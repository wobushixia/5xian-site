...
let IconPhoneLocked = class IconPhoneLocked extends LitElement {
    render() {
...
IconPhoneLocked.styles = style;
IconPhoneLocked = __decorate([
    customElement('mdui-icon-phone-locked')
], IconPhoneLocked);
