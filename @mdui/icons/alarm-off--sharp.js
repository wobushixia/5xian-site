...
let IconAlarmOff_Sharp = class IconAlarmOff_Sharp extends LitElement {
    render() {
...
IconAlarmOff_Sharp.styles = style;
IconAlarmOff_Sharp = __decorate([
    customElement('mdui-icon-alarm-off--sharp')
], IconAlarmOff_Sharp);
export { IconAlarmOff_Sharp };
