...
let IconSignalWifiStatusbarNull = class IconSignalWifiStatusbarNull extends LitElement {
    render() {
...
IconSignalWifiStatusbarNull.styles = style;
IconSignalWifiStatusbarNull = __decorate([
    customElement('mdui-icon-signal-wifi-statusbar-null')
