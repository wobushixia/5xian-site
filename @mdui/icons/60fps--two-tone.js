...
let Icon60fps_TwoTone = class Icon60fps_TwoTone extends LitElement {
    render() {
...
Icon60fps_TwoTone.styles = style;
Icon60fps_TwoTone = __decorate([
    customElement('mdui-icon-60fps--two-tone')
], Icon60fps_TwoTone);
export { Icon60fps_TwoTone };
