...
let IconSurfing_TwoTone = class IconSurfing_TwoTone extends LitElement {
    render() {
...
IconSurfing_TwoTone.styles = style;
IconSurfing_TwoTone = __decorate([
    customElement('mdui-icon-surfing--two-tone')
], IconSurfing_TwoTone);
export { IconSurfing_TwoTone };
