...
let IconDirectionsBoatFilled = class IconDirectionsBoatFilled extends LitElement {
    render() {
...
IconDirectionsBoatFilled.styles = style;
IconDirectionsBoatFilled = __decorate([
    customElement('mdui-icon-directions-boat-filled')
], IconDirectionsBoatFilled);
export { IconDirectionsBoatFilled };
