...
let IconPaid_Sharp = class IconPaid_Sharp extends LitElement {
    render() {
...
IconPaid_Sharp.styles = style;
IconPaid_Sharp = __decorate([
    customElement('mdui-icon-paid--sharp')
], IconPaid_Sharp);
export { IconPaid_Sharp };
