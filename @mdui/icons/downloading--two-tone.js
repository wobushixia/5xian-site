...
let IconDownloading_TwoTone = class IconDownloading_TwoTone extends LitElement {
    render() {
...
IconDownloading_TwoTone.styles = style;
IconDownloading_TwoTone = __decorate([
    customElement('mdui-icon-downloading--two-tone')
], IconDownloading_TwoTone);
export { IconDownloading_TwoTone };
