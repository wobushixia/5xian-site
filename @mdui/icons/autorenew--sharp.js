...
let IconAutorenew_Sharp = class IconAutorenew_Sharp extends LitElement {
    render() {
...
IconAutorenew_Sharp.styles = style;
IconAutorenew_Sharp = __decorate([
    customElement('mdui-icon-autorenew--sharp')
], IconAutorenew_Sharp);
export { IconAutorenew_Sharp };
