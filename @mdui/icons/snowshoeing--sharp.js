...
let IconSnowshoeing_Sharp = class IconSnowshoeing_Sharp extends LitElement {
    render() {
...
IconSnowshoeing_Sharp.styles = style;
IconSnowshoeing_Sharp = __decorate([
    customElement('mdui-icon-snowshoeing--sharp')
], IconSnowshoeing_Sharp);
export { IconSnowshoeing_Sharp };
