...
let IconFlightTakeoff_Rounded = class IconFlightTakeoff_Rounded extends LitElement {
    render() {
...
IconFlightTakeoff_Rounded.styles = style;
IconFlightTakeoff_Rounded = __decorate([
    customElement('mdui-icon-flight-takeoff--rounded')
], IconFlightTakeoff_Rounded);
export { IconFlightTakeoff_Rounded };
