...
let IconReplay_30_TwoTone = class IconReplay_30_TwoTone extends LitElement {
    render() {
...
IconReplay_30_TwoTone.styles = style;
IconReplay_30_TwoTone = __decorate([
    customElement('mdui-icon-replay-30--two-tone')
], IconReplay_30_TwoTone);
export { IconReplay_30_TwoTone };
