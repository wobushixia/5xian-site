...
let IconAssistWalker_TwoTone = class IconAssistWalker_TwoTone extends LitElement {
    render() {
...
IconAssistWalker_TwoTone.styles = style;
IconAssistWalker_TwoTone = __decorate([
    customElement('mdui-icon-assist-walker--two-tone')
], IconAssistWalker_TwoTone);
export { IconAssistWalker_TwoTone };
