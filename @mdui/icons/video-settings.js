...
let IconVideoSettings = class IconVideoSettings extends LitElement {
    render() {
...
IconVideoSettings.styles = style;
IconVideoSettings = __decorate([
    customElement('mdui-icon-video-settings')
], IconVideoSettings);
