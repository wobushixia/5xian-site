...
let IconSurfing_Outlined = class IconSurfing_Outlined extends LitElement {
    render() {
...
IconSurfing_Outlined.styles = style;
IconSurfing_Outlined = __decorate([
    customElement('mdui-icon-surfing--outlined')
], IconSurfing_Outlined);
export { IconSurfing_Outlined };
