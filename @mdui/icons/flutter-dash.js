...
let IconFlutterDash = class IconFlutterDash extends LitElement {
    render() {
...
IconFlutterDash.styles = style;
IconFlutterDash = __decorate([
    customElement('mdui-icon-flutter-dash')
], IconFlutterDash);
export { IconFlutterDash };
