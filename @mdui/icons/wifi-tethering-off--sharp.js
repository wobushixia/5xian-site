...
let IconWifiTetheringOff_Sharp = class IconWifiTetheringOff_Sharp extends LitElement {
    render() {
...
IconWifiTetheringOff_Sharp.styles = style;
IconWifiTetheringOff_Sharp = __decorate([
    customElement('mdui-icon-wifi-tethering-off--sharp')
], IconWifiTetheringOff_Sharp);
export { IconWifiTetheringOff_Sharp };
