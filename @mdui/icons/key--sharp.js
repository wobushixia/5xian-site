...
let IconKey_Sharp = class IconKey_Sharp extends LitElement {
    render() {
...
IconKey_Sharp.styles = style;
IconKey_Sharp = __decorate([
    customElement('mdui-icon-key--sharp')
], IconKey_Sharp);
export { IconKey_Sharp };
