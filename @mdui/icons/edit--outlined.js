...
let IconEdit_Outlined = class IconEdit_Outlined extends LitElement {
    render() {
...
IconEdit_Outlined.styles = style;
IconEdit_Outlined = __decorate([
    customElement('mdui-icon-edit--outlined')
], IconEdit_Outlined);
export { IconEdit_Outlined };
