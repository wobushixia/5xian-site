...
let IconNoTransfer_Sharp = class IconNoTransfer_Sharp extends LitElement {
    render() {
...
IconNoTransfer_Sharp.styles = style;
IconNoTransfer_Sharp = __decorate([
    customElement('mdui-icon-no-transfer--sharp')
], IconNoTransfer_Sharp);
export { IconNoTransfer_Sharp };
