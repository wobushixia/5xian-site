...
let IconAddToDrive_Sharp = class IconAddToDrive_Sharp extends LitElement {
    render() {
...
IconAddToDrive_Sharp.styles = style;
IconAddToDrive_Sharp = __decorate([
    customElement('mdui-icon-add-to-drive--sharp')
], IconAddToDrive_Sharp);
export { IconAddToDrive_Sharp };
