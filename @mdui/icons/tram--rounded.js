...
let IconTram_Rounded = class IconTram_Rounded extends LitElement {
    render() {
...
IconTram_Rounded.styles = style;
IconTram_Rounded = __decorate([
    customElement('mdui-icon-tram--rounded')
], IconTram_Rounded);
export { IconTram_Rounded };
