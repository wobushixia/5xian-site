...
let IconMasks_Sharp = class IconMasks_Sharp extends LitElement {
    render() {
...
IconMasks_Sharp.styles = style;
IconMasks_Sharp = __decorate([
    customElement('mdui-icon-masks--sharp')
], IconMasks_Sharp);
export { IconMasks_Sharp };
