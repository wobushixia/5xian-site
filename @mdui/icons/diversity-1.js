...
let IconDiversity_1 = class IconDiversity_1 extends LitElement {
    render() {
...
IconDiversity_1.styles = style;
IconDiversity_1 = __decorate([
    customElement('mdui-icon-diversity-1')
], IconDiversity_1);
export { IconDiversity_1 };
