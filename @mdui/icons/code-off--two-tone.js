...
let IconCodeOff_TwoTone = class IconCodeOff_TwoTone extends LitElement {
    render() {
...
IconCodeOff_TwoTone.styles = style;
IconCodeOff_TwoTone = __decorate([
    customElement('mdui-icon-code-off--two-tone')
], IconCodeOff_TwoTone);
