...
let IconEmojiSymbols_Sharp = class IconEmojiSymbols_Sharp extends LitElement {
    render() {
...
IconEmojiSymbols_Sharp.styles = style;
IconEmojiSymbols_Sharp = __decorate([
    customElement('mdui-icon-emoji-symbols--sharp')
], IconEmojiSymbols_Sharp);
export { IconEmojiSymbols_Sharp };
