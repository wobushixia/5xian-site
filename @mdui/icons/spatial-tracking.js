...
let IconSpatialTracking = class IconSpatialTracking extends LitElement {
    render() {
...
IconSpatialTracking.styles = style;
IconSpatialTracking = __decorate([
    customElement('mdui-icon-spatial-tracking')
], IconSpatialTracking);
export { IconSpatialTracking };
