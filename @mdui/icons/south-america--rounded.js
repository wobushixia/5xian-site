...
let IconSouthAmerica_Rounded = class IconSouthAmerica_Rounded extends LitElement {
    render() {
...
IconSouthAmerica_Rounded.styles = style;
IconSouthAmerica_Rounded = __decorate([
    customElement('mdui-icon-south-america--rounded')
], IconSouthAmerica_Rounded);
export { IconSouthAmerica_Rounded };
