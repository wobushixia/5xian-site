...
let IconAir_TwoTone = class IconAir_TwoTone extends LitElement {
    render() {
...
IconAir_TwoTone.styles = style;
IconAir_TwoTone = __decorate([
    customElement('mdui-icon-air--two-tone')
], IconAir_TwoTone);
export { IconAir_TwoTone };
