...
let IconTimer_10_Rounded = class IconTimer_10_Rounded extends LitElement {
    render() {
...
IconTimer_10_Rounded.styles = style;
IconTimer_10_Rounded = __decorate([
    customElement('mdui-icon-timer-10--rounded')
], IconTimer_10_Rounded);
export { IconTimer_10_Rounded };
