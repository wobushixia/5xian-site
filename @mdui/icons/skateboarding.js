...
let IconSkateboarding = class IconSkateboarding extends LitElement {
    render() {
...
IconSkateboarding.styles = style;
IconSkateboarding = __decorate([
    customElement('mdui-icon-skateboarding')
], IconSkateboarding);
