...
let IconDoDisturbOff = class IconDoDisturbOff extends LitElement {
    render() {
...
IconDoDisturbOff.styles = style;
IconDoDisturbOff = __decorate([
    customElement('mdui-icon-do-disturb-off')
], IconDoDisturbOff);
export { IconDoDisturbOff };
