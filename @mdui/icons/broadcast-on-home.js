...
let IconBroadcastOnHome = class IconBroadcastOnHome extends LitElement {
    render() {
...
IconBroadcastOnHome.styles = style;
IconBroadcastOnHome = __decorate([
    customElement('mdui-icon-broadcast-on-home')
], IconBroadcastOnHome);
export { IconBroadcastOnHome };
