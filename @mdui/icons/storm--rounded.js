...
let IconStorm_Rounded = class IconStorm_Rounded extends LitElement {
    render() {
...
IconStorm_Rounded.styles = style;
IconStorm_Rounded = __decorate([
    customElement('mdui-icon-storm--rounded')
], IconStorm_Rounded);
export { IconStorm_Rounded };
