...
let Icon24mp_Rounded = class Icon24mp_Rounded extends LitElement {
    render() {
...
Icon24mp_Rounded.styles = style;
Icon24mp_Rounded = __decorate([
    customElement('mdui-icon-24mp--rounded')
], Icon24mp_Rounded);
export { Icon24mp_Rounded };
