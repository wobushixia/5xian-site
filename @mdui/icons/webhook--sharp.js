...
let IconWebhook_Sharp = class IconWebhook_Sharp extends LitElement {
    render() {
...
IconWebhook_Sharp.styles = style;
IconWebhook_Sharp = __decorate([
    customElement('mdui-icon-webhook--sharp')
], IconWebhook_Sharp);
export { IconWebhook_Sharp };
