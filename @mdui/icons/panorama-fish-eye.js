...
let IconPanoramaFishEye = class IconPanoramaFishEye extends LitElement {
    render() {
...
IconPanoramaFishEye.styles = style;
IconPanoramaFishEye = __decorate([
    customElement('mdui-icon-panorama-fish-eye')
], IconPanoramaFishEye);
