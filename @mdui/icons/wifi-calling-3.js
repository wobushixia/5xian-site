...
let IconWifiCalling_3 = class IconWifiCalling_3 extends LitElement {
    render() {
...
IconWifiCalling_3.styles = style;
IconWifiCalling_3 = __decorate([
    customElement('mdui-icon-wifi-calling-3')
], IconWifiCalling_3);
export { IconWifiCalling_3 };
