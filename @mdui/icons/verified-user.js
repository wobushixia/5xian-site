...
let IconVerifiedUser = class IconVerifiedUser extends LitElement {
    render() {
...
IconVerifiedUser.styles = style;
IconVerifiedUser = __decorate([
    customElement('mdui-icon-verified-user')
], IconVerifiedUser);
