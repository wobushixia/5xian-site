...
let IconHearingDisabled_Sharp = class IconHearingDisabled_Sharp extends LitElement {
    render() {
...
IconHearingDisabled_Sharp.styles = style;
IconHearingDisabled_Sharp = __decorate([
    customElement('mdui-icon-hearing-disabled--sharp')
], IconHearingDisabled_Sharp);
export { IconHearingDisabled_Sharp };
