...
let Icon19mp_Outlined = class Icon19mp_Outlined extends LitElement {
    render() {
...
Icon19mp_Outlined.styles = style;
Icon19mp_Outlined = __decorate([
    customElement('mdui-icon-19mp--outlined')
], Icon19mp_Outlined);
export { Icon19mp_Outlined };
