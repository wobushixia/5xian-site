...
let IconFitbit_Sharp = class IconFitbit_Sharp extends LitElement {
    render() {
...
IconFitbit_Sharp.styles = style;
IconFitbit_Sharp = __decorate([
    customElement('mdui-icon-fitbit--sharp')
], IconFitbit_Sharp);
export { IconFitbit_Sharp };
