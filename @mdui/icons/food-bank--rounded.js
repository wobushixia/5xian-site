...
let IconFoodBank_Rounded = class IconFoodBank_Rounded extends LitElement {
    render() {
...
IconFoodBank_Rounded.styles = style;
IconFoodBank_Rounded = __decorate([
    customElement('mdui-icon-food-bank--rounded')
], IconFoodBank_Rounded);
export { IconFoodBank_Rounded };
