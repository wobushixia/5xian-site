...
let IconAnimation_Outlined = class IconAnimation_Outlined extends LitElement {
    render() {
...
IconAnimation_Outlined.styles = style;
IconAnimation_Outlined = __decorate([
    customElement('mdui-icon-animation--outlined')
], IconAnimation_Outlined);
export { IconAnimation_Outlined };
