...
let IconHls_TwoTone = class IconHls_TwoTone extends LitElement {
    render() {
...
IconHls_TwoTone.styles = style;
IconHls_TwoTone = __decorate([
    customElement('mdui-icon-hls--two-tone')
], IconHls_TwoTone);
export { IconHls_TwoTone };
