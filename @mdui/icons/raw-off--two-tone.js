...
let IconRawOff_TwoTone = class IconRawOff_TwoTone extends LitElement {
    render() {
...
IconRawOff_TwoTone.styles = style;
IconRawOff_TwoTone = __decorate([
    customElement('mdui-icon-raw-off--two-tone')
], IconRawOff_TwoTone);
export { IconRawOff_TwoTone };
