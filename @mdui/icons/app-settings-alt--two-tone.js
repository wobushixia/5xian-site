...
let IconAppSettingsAlt_TwoTone = class IconAppSettingsAlt_TwoTone extends LitElement {
    render() {
...
IconAppSettingsAlt_TwoTone.styles = style;
IconAppSettingsAlt_TwoTone = __decorate([
    customElement('mdui-icon-app-settings-alt--two-tone')
], IconAppSettingsAlt_TwoTone);
export { IconAppSettingsAlt_TwoTone };
