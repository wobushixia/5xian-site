...
let IconGpsOff_Rounded = class IconGpsOff_Rounded extends LitElement {
    render() {
...
IconGpsOff_Rounded.styles = style;
IconGpsOff_Rounded = __decorate([
    customElement('mdui-icon-gps-off--rounded')
], IconGpsOff_Rounded);
export { IconGpsOff_Rounded };
