...
let IconMotionPhotosPause = class IconMotionPhotosPause extends LitElement {
    render() {
...
IconMotionPhotosPause.styles = style;
IconMotionPhotosPause = __decorate([
    customElement('mdui-icon-motion-photos-pause')
