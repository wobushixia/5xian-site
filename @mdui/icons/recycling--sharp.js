...
let IconRecycling_Sharp = class IconRecycling_Sharp extends LitElement {
    render() {
...
IconRecycling_Sharp.styles = style;
IconRecycling_Sharp = __decorate([
    customElement('mdui-icon-recycling--sharp')
], IconRecycling_Sharp);
export { IconRecycling_Sharp };
