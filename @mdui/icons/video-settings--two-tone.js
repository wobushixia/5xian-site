...
let IconVideoSettings_TwoTone = class IconVideoSettings_TwoTone extends LitElement {
    render() {
...
IconVideoSettings_TwoTone.styles = style;
IconVideoSettings_TwoTone = __decorate([
    customElement('mdui-icon-video-settings--two-tone')
], IconVideoSettings_TwoTone);
export { IconVideoSettings_TwoTone };
