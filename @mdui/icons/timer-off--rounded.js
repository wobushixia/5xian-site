...
let IconTimerOff_Rounded = class IconTimerOff_Rounded extends LitElement {
    render() {
...
IconTimerOff_Rounded.styles = style;
IconTimerOff_Rounded = __decorate([
    customElement('mdui-icon-timer-off--rounded')
], IconTimerOff_Rounded);
export { IconTimerOff_Rounded };
