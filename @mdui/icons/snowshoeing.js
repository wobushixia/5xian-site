...
let IconSnowshoeing = class IconSnowshoeing extends LitElement {
    render() {
...
IconSnowshoeing.styles = style;
IconSnowshoeing = __decorate([
    customElement('mdui-icon-snowshoeing')
], IconSnowshoeing);
export { IconSnowshoeing };
