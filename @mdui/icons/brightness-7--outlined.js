...
let IconBrightness_7_Outlined = class IconBrightness_7_Outlined extends LitElement {
    render() {
...
IconBrightness_7_Outlined.styles = style;
IconBrightness_7_Outlined = __decorate([
    customElement('mdui-icon-brightness-7--outlined')
], IconBrightness_7_Outlined);
export { IconBrightness_7_Outlined };
