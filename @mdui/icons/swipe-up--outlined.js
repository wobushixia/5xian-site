...
let IconSwipeUp_Outlined = class IconSwipeUp_Outlined extends LitElement {
    render() {
...
IconSwipeUp_Outlined.styles = style;
IconSwipeUp_Outlined = __decorate([
    customElement('mdui-icon-swipe-up--outlined')
], IconSwipeUp_Outlined);
export { IconSwipeUp_Outlined };
