...
let IconSpatialAudioOff = class IconSpatialAudioOff extends LitElement {
    render() {
...
IconSpatialAudioOff.styles = style;
IconSpatialAudioOff = __decorate([
    customElement('mdui-icon-spatial-audio-off')
], IconSpatialAudioOff);
export { IconSpatialAudioOff };
