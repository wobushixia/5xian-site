...
let IconThermostatAuto_Rounded = class IconThermostatAuto_Rounded extends LitElement {
    render() {
...
IconThermostatAuto_Rounded.styles = style;
IconThermostatAuto_Rounded = __decorate([
    customElement('mdui-icon-thermostat-auto--rounded')
], IconThermostatAuto_Rounded);
export { IconThermostatAuto_Rounded };
