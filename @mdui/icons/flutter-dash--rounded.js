...
let IconFlutterDash_Rounded = class IconFlutterDash_Rounded extends LitElement {
    render() {
...
IconFlutterDash_Rounded.styles = style;
IconFlutterDash_Rounded = __decorate([
    customElement('mdui-icon-flutter-dash--rounded')
], IconFlutterDash_Rounded);
export { IconFlutterDash_Rounded };
