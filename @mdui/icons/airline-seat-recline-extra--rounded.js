...
let IconAirlineSeatReclineExtra_Rounded = class IconAirlineSeatReclineExtra_Rounded extends LitElement {
    render() {
...
IconAirlineSeatReclineExtra_Rounded.styles = style;
IconAirlineSeatReclineExtra_Rounded = __decorate([
    customElement('mdui-icon-airline-seat-recline-extra--rounded')
], IconAirlineSeatReclineExtra_Rounded);
export { IconAirlineSeatReclineExtra_Rounded };
