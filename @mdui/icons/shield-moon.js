...
let IconShieldMoon = class IconShieldMoon extends LitElement {
    render() {
...
IconShieldMoon.styles = style;
IconShieldMoon = __decorate([
    customElement('mdui-icon-shield-moon')
], IconShieldMoon);
export { IconShieldMoon };
