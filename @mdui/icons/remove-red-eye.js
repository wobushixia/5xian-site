...
let IconRemoveRedEye = class IconRemoveRedEye extends LitElement {
    render() {
...
IconRemoveRedEye.styles = style;
IconRemoveRedEye = __decorate([
    customElement('mdui-icon-remove-red-eye')
], IconRemoveRedEye);
