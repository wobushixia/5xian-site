...
let IconSnowboarding = class IconSnowboarding extends LitElement {
    render() {
...
IconSnowboarding.styles = style;
IconSnowboarding = __decorate([
    customElement('mdui-icon-snowboarding')
], IconSnowboarding);
