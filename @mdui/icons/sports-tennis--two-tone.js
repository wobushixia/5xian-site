...
let IconSportsTennis_TwoTone = class IconSportsTennis_TwoTone extends LitElement {
    render() {
...
IconSportsTennis_TwoTone.styles = style;
IconSportsTennis_TwoTone = __decorate([
    customElement('mdui-icon-sports-tennis--two-tone')
], IconSportsTennis_TwoTone);
export { IconSportsTennis_TwoTone };
