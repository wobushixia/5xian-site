...
let IconSwapHorizontalCircle = class IconSwapHorizontalCircle extends LitElement {
    render() {
...
IconSwapHorizontalCircle.styles = style;
IconSwapHorizontalCircle = __decorate([
    customElement('mdui-icon-swap-horizontal-circle')
