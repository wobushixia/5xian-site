...
let IconEmojiObjects = class IconEmojiObjects extends LitElement {
    render() {
...
IconEmojiObjects.styles = style;
IconEmojiObjects = __decorate([
    customElement('mdui-icon-emoji-objects')
], IconEmojiObjects);
