...
let IconBlinds_Sharp = class IconBlinds_Sharp extends LitElement {
    render() {
...
IconBlinds_Sharp.styles = style;
IconBlinds_Sharp = __decorate([
    customElement('mdui-icon-blinds--sharp')
], IconBlinds_Sharp);
export { IconBlinds_Sharp };
