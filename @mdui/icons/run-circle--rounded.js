...
let IconRunCircle_Rounded = class IconRunCircle_Rounded extends LitElement {
    render() {
...
IconRunCircle_Rounded.styles = style;
IconRunCircle_Rounded = __decorate([
    customElement('mdui-icon-run-circle--rounded')
], IconRunCircle_Rounded);
export { IconRunCircle_Rounded };
