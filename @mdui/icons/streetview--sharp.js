...
let IconStreetview_Sharp = class IconStreetview_Sharp extends LitElement {
    render() {
...
IconStreetview_Sharp.styles = style;
IconStreetview_Sharp = __decorate([
    customElement('mdui-icon-streetview--sharp')
], IconStreetview_Sharp);
export { IconStreetview_Sharp };
