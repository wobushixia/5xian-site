...
let IconGames_Outlined = class IconGames_Outlined extends LitElement {
    render() {
...
IconGames_Outlined.styles = style;
IconGames_Outlined = __decorate([
    customElement('mdui-icon-games--outlined')
], IconGames_Outlined);
export { IconGames_Outlined };
