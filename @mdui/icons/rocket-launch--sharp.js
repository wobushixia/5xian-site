...
let IconRocketLaunch_Sharp = class IconRocketLaunch_Sharp extends LitElement {
    render() {
...
IconRocketLaunch_Sharp.styles = style;
IconRocketLaunch_Sharp = __decorate([
    customElement('mdui-icon-rocket-launch--sharp')
], IconRocketLaunch_Sharp);
export { IconRocketLaunch_Sharp };
