...
let Icon6kPlus_Rounded = class Icon6kPlus_Rounded extends LitElement {
    render() {
...
Icon6kPlus_Rounded.styles = style;
Icon6kPlus_Rounded = __decorate([
    customElement('mdui-icon-6k-plus--rounded')
], Icon6kPlus_Rounded);
export { Icon6kPlus_Rounded };
