...
let IconSportsSoccer_Outlined = class IconSportsSoccer_Outlined extends LitElement {
    render() {
...
IconSportsSoccer_Outlined.styles = style;
IconSportsSoccer_Outlined = __decorate([
    customElement('mdui-icon-sports-soccer--outlined')
], IconSportsSoccer_Outlined);
export { IconSportsSoccer_Outlined };
