...
let IconManageHistory_Sharp = class IconManageHistory_Sharp extends LitElement {
    render() {
...
IconManageHistory_Sharp.styles = style;
IconManageHistory_Sharp = __decorate([
    customElement('mdui-icon-manage-history--sharp')
], IconManageHistory_Sharp);
export { IconManageHistory_Sharp };
