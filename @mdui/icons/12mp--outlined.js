...
let Icon12mp_Outlined = class Icon12mp_Outlined extends LitElement {
    render() {
...
Icon12mp_Outlined.styles = style;
Icon12mp_Outlined = __decorate([
    customElement('mdui-icon-12mp--outlined')
], Icon12mp_Outlined);
export { Icon12mp_Outlined };
