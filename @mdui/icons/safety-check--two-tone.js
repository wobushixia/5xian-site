...
let IconSafetyCheck_TwoTone = class IconSafetyCheck_TwoTone extends LitElement {
    render() {
...
IconSafetyCheck_TwoTone.styles = style;
IconSafetyCheck_TwoTone = __decorate([
    customElement('mdui-icon-safety-check--two-tone')
], IconSafetyCheck_TwoTone);
export { IconSafetyCheck_TwoTone };
