...
let IconEmojiObjects_Rounded = class IconEmojiObjects_Rounded extends LitElement {
    render() {
...
IconEmojiObjects_Rounded.styles = style;
IconEmojiObjects_Rounded = __decorate([
    customElement('mdui-icon-emoji-objects--rounded')
], IconEmojiObjects_Rounded);
export { IconEmojiObjects_Rounded };
