...
let IconTrain_TwoTone = class IconTrain_TwoTone extends LitElement {
    render() {
...
IconTrain_TwoTone.styles = style;
IconTrain_TwoTone = __decorate([
    customElement('mdui-icon-train--two-tone')
], IconTrain_TwoTone);
export { IconTrain_TwoTone };
