...
let IconPlayForWork = class IconPlayForWork extends LitElement {
    render() {
...
IconPlayForWork.styles = style;
IconPlayForWork = __decorate([
    customElement('mdui-icon-play-for-work')
], IconPlayForWork);
