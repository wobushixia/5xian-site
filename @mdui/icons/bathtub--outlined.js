...
let IconBathtub_Outlined = class IconBathtub_Outlined extends LitElement {
    render() {
...
IconBathtub_Outlined.styles = style;
IconBathtub_Outlined = __decorate([
    customElement('mdui-icon-bathtub--outlined')
], IconBathtub_Outlined);
export { IconBathtub_Outlined };
