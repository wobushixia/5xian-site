...
let IconTransgender_Sharp = class IconTransgender_Sharp extends LitElement {
    render() {
...
IconTransgender_Sharp.styles = style;
IconTransgender_Sharp = __decorate([
    customElement('mdui-icon-transgender--sharp')
], IconTransgender_Sharp);
export { IconTransgender_Sharp };
