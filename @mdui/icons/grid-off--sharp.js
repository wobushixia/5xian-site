...
let IconGridOff_Sharp = class IconGridOff_Sharp extends LitElement {
    render() {
...
IconGridOff_Sharp.styles = style;
IconGridOff_Sharp = __decorate([
    customElement('mdui-icon-grid-off--sharp')
], IconGridOff_Sharp);
export { IconGridOff_Sharp };
