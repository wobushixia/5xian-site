...
let IconGames_Rounded = class IconGames_Rounded extends LitElement {
    render() {
...
IconGames_Rounded.styles = style;
IconGames_Rounded = __decorate([
    customElement('mdui-icon-games--rounded')
], IconGames_Rounded);
export { IconGames_Rounded };
