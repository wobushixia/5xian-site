...
let IconSwitchAccessShortcut_Sharp = class IconSwitchAccessShortcut_Sharp extends LitElement {
    render() {
...
IconSwitchAccessShortcut_Sharp.styles = style;
IconSwitchAccessShortcut_Sharp = __decorate([
    customElement('mdui-icon-switch-access-shortcut--sharp')
], IconSwitchAccessShortcut_Sharp);
export { IconSwitchAccessShortcut_Sharp };
