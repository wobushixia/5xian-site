...
let IconHdrOnSelect_Rounded = class IconHdrOnSelect_Rounded extends LitElement {
    render() {
...
IconHdrOnSelect_Rounded.styles = style;
IconHdrOnSelect_Rounded = __decorate([
    customElement('mdui-icon-hdr-on-select--rounded')
], IconHdrOnSelect_Rounded);
export { IconHdrOnSelect_Rounded };
