...
let IconWallpaper_Outlined = class IconWallpaper_Outlined extends LitElement {
    render() {
...
IconWallpaper_Outlined.styles = style;
IconWallpaper_Outlined = __decorate([
    customElement('mdui-icon-wallpaper--outlined')
], IconWallpaper_Outlined);
export { IconWallpaper_Outlined };
