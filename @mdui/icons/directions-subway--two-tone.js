...
let IconDirectionsSubway_TwoTone = class IconDirectionsSubway_TwoTone extends LitElement {
    render() {
...
IconDirectionsSubway_TwoTone.styles = style;
IconDirectionsSubway_TwoTone = __decorate([
    customElement('mdui-icon-directions-subway--two-tone')
], IconDirectionsSubway_TwoTone);
export { IconDirectionsSubway_TwoTone };
