...
let IconBikeScooter_TwoTone = class IconBikeScooter_TwoTone extends LitElement {
    render() {
...
IconBikeScooter_TwoTone.styles = style;
IconBikeScooter_TwoTone = __decorate([
    customElement('mdui-icon-bike-scooter--two-tone')
], IconBikeScooter_TwoTone);
export { IconBikeScooter_TwoTone };
