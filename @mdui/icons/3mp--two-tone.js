...
let Icon3mp_TwoTone = class Icon3mp_TwoTone extends LitElement {
    render() {
...
Icon3mp_TwoTone.styles = style;
Icon3mp_TwoTone = __decorate([
    customElement('mdui-icon-3mp--two-tone')
], Icon3mp_TwoTone);
export { Icon3mp_TwoTone };
