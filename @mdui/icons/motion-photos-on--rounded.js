...
let IconMotionPhotosOn_Rounded = class IconMotionPhotosOn_Rounded extends LitElement {
    render() {
...
IconMotionPhotosOn_Rounded.styles = style;
IconMotionPhotosOn_Rounded = __decorate([
    customElement('mdui-icon-motion-photos-on--rounded')
], IconMotionPhotosOn_Rounded);
export { IconMotionPhotosOn_Rounded };
