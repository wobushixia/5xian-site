...
let IconThermostatAuto = class IconThermostatAuto extends LitElement {
    render() {
...
IconThermostatAuto.styles = style;
IconThermostatAuto = __decorate([
    customElement('mdui-icon-thermostat-auto')
], IconThermostatAuto);
export { IconThermostatAuto };
