...
let IconSportsSoccer_Sharp = class IconSportsSoccer_Sharp extends LitElement {
    render() {
...
IconSportsSoccer_Sharp.styles = style;
IconSportsSoccer_Sharp = __decorate([
    customElement('mdui-icon-sports-soccer--sharp')
], IconSportsSoccer_Sharp);
export { IconSportsSoccer_Sharp };
