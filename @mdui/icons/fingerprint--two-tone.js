...
let IconFingerprint_TwoTone = class IconFingerprint_TwoTone extends LitElement {
    render() {
...
IconFingerprint_TwoTone.styles = style;
IconFingerprint_TwoTone = __decorate([
    customElement('mdui-icon-fingerprint--two-tone')
], IconFingerprint_TwoTone);
export { IconFingerprint_TwoTone };
