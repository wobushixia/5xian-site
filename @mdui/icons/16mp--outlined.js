...
let Icon16mp_Outlined = class Icon16mp_Outlined extends LitElement {
    render() {
...
Icon16mp_Outlined.styles = style;
Icon16mp_Outlined = __decorate([
    customElement('mdui-icon-16mp--outlined')
], Icon16mp_Outlined);
export { Icon16mp_Outlined };
