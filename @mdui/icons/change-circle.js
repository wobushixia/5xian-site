...
let IconChangeCircle = class IconChangeCircle extends LitElement {
    render() {
...
IconChangeCircle.styles = style;
IconChangeCircle = __decorate([
    customElement('mdui-icon-change-circle')
], IconChangeCircle);
export { IconChangeCircle };
