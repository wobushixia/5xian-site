...
let IconReduceCapacity_Sharp = class IconReduceCapacity_Sharp extends LitElement {
    render() {
...
IconReduceCapacity_Sharp.styles = style;
IconReduceCapacity_Sharp = __decorate([
    customElement('mdui-icon-reduce-capacity--sharp')
], IconReduceCapacity_Sharp);
export { IconReduceCapacity_Sharp };
