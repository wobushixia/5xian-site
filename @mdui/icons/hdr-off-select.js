...
let IconHdrOffSelect = class IconHdrOffSelect extends LitElement {
    render() {
...
IconHdrOffSelect.styles = style;
IconHdrOffSelect = __decorate([
    customElement('mdui-icon-hdr-off-select')
], IconHdrOffSelect);
export { IconHdrOffSelect };
