...
let IconThunderstorm_Rounded = class IconThunderstorm_Rounded extends LitElement {
    render() {
...
IconThunderstorm_Rounded.styles = style;
IconThunderstorm_Rounded = __decorate([
    customElement('mdui-icon-thunderstorm--rounded')
], IconThunderstorm_Rounded);
export { IconThunderstorm_Rounded };
