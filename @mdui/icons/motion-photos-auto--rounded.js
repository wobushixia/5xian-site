...
let IconMotionPhotosAuto_Rounded = class IconMotionPhotosAuto_Rounded extends LitElement {
    render() {
...
IconMotionPhotosAuto_Rounded.styles = style;
IconMotionPhotosAuto_Rounded = __decorate([
    customElement('mdui-icon-motion-photos-auto--rounded')
], IconMotionPhotosAuto_Rounded);
export { IconMotionPhotosAuto_Rounded };
