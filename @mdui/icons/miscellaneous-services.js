...
let IconMiscellaneousServices = class IconMiscellaneousServices extends LitElement {
    render() {
...
IconMiscellaneousServices.styles = style;
IconMiscellaneousServices = __decorate([
    customElement('mdui-icon-miscellaneous-services')
], IconMiscellaneousServices);
export { IconMiscellaneousServices };
