...
let IconFingerprint_Rounded = class IconFingerprint_Rounded extends LitElement {
    render() {
...
IconFingerprint_Rounded.styles = style;
IconFingerprint_Rounded = __decorate([
    customElement('mdui-icon-fingerprint--rounded')
], IconFingerprint_Rounded);
export { IconFingerprint_Rounded };
