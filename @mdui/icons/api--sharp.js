...
let IconApi_Sharp = class IconApi_Sharp extends LitElement {
    render() {
...
IconApi_Sharp.styles = style;
IconApi_Sharp = __decorate([
    customElement('mdui-icon-api--sharp')
], IconApi_Sharp);
export { IconApi_Sharp };
