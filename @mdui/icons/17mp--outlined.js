...
let Icon17mp_Outlined = class Icon17mp_Outlined extends LitElement {
    render() {
...
Icon17mp_Outlined.styles = style;
Icon17mp_Outlined = __decorate([
    customElement('mdui-icon-17mp--outlined')
], Icon17mp_Outlined);
export { Icon17mp_Outlined };
