...
let IconPublicOff_Sharp = class IconPublicOff_Sharp extends LitElement {
    render() {
...
IconPublicOff_Sharp.styles = style;
IconPublicOff_Sharp = __decorate([
    customElement('mdui-icon-public-off--sharp')
], IconPublicOff_Sharp);
export { IconPublicOff_Sharp };
