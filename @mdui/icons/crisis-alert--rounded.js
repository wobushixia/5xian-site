...
let IconCrisisAlert_Rounded = class IconCrisisAlert_Rounded extends LitElement {
    render() {
...
IconCrisisAlert_Rounded.styles = style;
IconCrisisAlert_Rounded = __decorate([
    customElement('mdui-icon-crisis-alert--rounded')
], IconCrisisAlert_Rounded);
export { IconCrisisAlert_Rounded };
