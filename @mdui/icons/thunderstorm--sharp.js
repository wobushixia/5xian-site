...
let IconThunderstorm_Sharp = class IconThunderstorm_Sharp extends LitElement {
    render() {
...
IconThunderstorm_Sharp.styles = style;
IconThunderstorm_Sharp = __decorate([
    customElement('mdui-icon-thunderstorm--sharp')
], IconThunderstorm_Sharp);
export { IconThunderstorm_Sharp };
