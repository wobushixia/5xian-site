...
let IconCloudOff_Rounded = class IconCloudOff_Rounded extends LitElement {
    render() {
...
IconCloudOff_Rounded.styles = style;
IconCloudOff_Rounded = __decorate([
    customElement('mdui-icon-cloud-off--rounded')
], IconCloudOff_Rounded);
export { IconCloudOff_Rounded };
