...
let IconUpdateDisabled = class IconUpdateDisabled extends LitElement {
    render() {
...
IconUpdateDisabled.styles = style;
IconUpdateDisabled = __decorate([
    customElement('mdui-icon-update-disabled')
], IconUpdateDisabled);
