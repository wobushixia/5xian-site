...
let IconLeakRemove_TwoTone = class IconLeakRemove_TwoTone extends LitElement {
    render() {
...
IconLeakRemove_TwoTone.styles = style;
IconLeakRemove_TwoTone = __decorate([
    customElement('mdui-icon-leak-remove--two-tone')
], IconLeakRemove_TwoTone);
export { IconLeakRemove_TwoTone };
