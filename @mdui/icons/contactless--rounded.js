...
let IconContactless_Rounded = class IconContactless_Rounded extends LitElement {
    render() {
...
IconContactless_Rounded.styles = style;
IconContactless_Rounded = __decorate([
    customElement('mdui-icon-contactless--rounded')
], IconContactless_Rounded);
export { IconContactless_Rounded };
