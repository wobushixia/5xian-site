...
let IconWifi_2Bar = class IconWifi_2Bar extends LitElement {
    render() {
...
IconWifi_2Bar.styles = style;
IconWifi_2Bar = __decorate([
    customElement('mdui-icon-wifi-2-bar')
], IconWifi_2Bar);
export { IconWifi_2Bar };
