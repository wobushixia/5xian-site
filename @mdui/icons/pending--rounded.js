...
let IconPending_Rounded = class IconPending_Rounded extends LitElement {
    render() {
...
IconPending_Rounded.styles = style;
IconPending_Rounded = __decorate([
    customElement('mdui-icon-pending--rounded')
], IconPending_Rounded);
export { IconPending_Rounded };
