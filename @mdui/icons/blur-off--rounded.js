...
let IconBlurOff_Rounded = class IconBlurOff_Rounded extends LitElement {
    render() {
...
IconBlurOff_Rounded.styles = style;
IconBlurOff_Rounded = __decorate([
    customElement('mdui-icon-blur-off--rounded')
], IconBlurOff_Rounded);
export { IconBlurOff_Rounded };
