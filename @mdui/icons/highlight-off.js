...
let IconHighlightOff = class IconHighlightOff extends LitElement {
    render() {
...
IconHighlightOff.styles = style;
IconHighlightOff = __decorate([
    customElement('mdui-icon-highlight-off')
], IconHighlightOff);
