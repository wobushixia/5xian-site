...
let Icon6mp_Outlined = class Icon6mp_Outlined extends LitElement {
    render() {
...
Icon6mp_Outlined.styles = style;
Icon6mp_Outlined = __decorate([
    customElement('mdui-icon-6mp--outlined')
], Icon6mp_Outlined);
export { Icon6mp_Outlined };
