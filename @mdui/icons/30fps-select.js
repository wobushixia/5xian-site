...
let Icon30fpsSelect = class Icon30fpsSelect extends LitElement {
    render() {
...
Icon30fpsSelect.styles = style;
Icon30fpsSelect = __decorate([
    customElement('mdui-icon-30fps-select')
], Icon30fpsSelect);
export { Icon30fpsSelect };
