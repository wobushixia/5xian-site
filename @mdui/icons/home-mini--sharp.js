...
let IconHomeMini_Sharp = class IconHomeMini_Sharp extends LitElement {
    render() {
...
IconHomeMini_Sharp.styles = style;
IconHomeMini_Sharp = __decorate([
    customElement('mdui-icon-home-mini--sharp')
], IconHomeMini_Sharp);
export { IconHomeMini_Sharp };
