...
let IconJoinInner_TwoTone = class IconJoinInner_TwoTone extends LitElement {
    render() {
...
IconJoinInner_TwoTone.styles = style;
IconJoinInner_TwoTone = __decorate([
    customElement('mdui-icon-join-inner--two-tone')
], IconJoinInner_TwoTone);
export { IconJoinInner_TwoTone };
