...
let IconModeStandby = class IconModeStandby extends LitElement {
    render() {
...
IconModeStandby.styles = style;
IconModeStandby = __decorate([
    customElement('mdui-icon-mode-standby')
], IconModeStandby);
export { IconModeStandby };
