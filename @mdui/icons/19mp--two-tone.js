...
let Icon19mp_TwoTone = class Icon19mp_TwoTone extends LitElement {
    render() {
...
Icon19mp_TwoTone.styles = style;
Icon19mp_TwoTone = __decorate([
    customElement('mdui-icon-19mp--two-tone')
], Icon19mp_TwoTone);
export { Icon19mp_TwoTone };
