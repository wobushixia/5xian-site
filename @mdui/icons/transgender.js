...
let IconTransgender = class IconTransgender extends LitElement {
    render() {
...
IconTransgender.styles = style;
IconTransgender = __decorate([
    customElement('mdui-icon-transgender')
], IconTransgender);
export { IconTransgender };
