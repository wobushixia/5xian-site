...
let Icon6FtApart_Rounded = class Icon6FtApart_Rounded extends LitElement {
    render() {
...
Icon6FtApart_Rounded.styles = style;
Icon6FtApart_Rounded = __decorate([
    customElement('mdui-icon-6-ft-apart--rounded')
], Icon6FtApart_Rounded);
export { Icon6FtApart_Rounded };
