...
let IconZoomOut_Outlined = class IconZoomOut_Outlined extends LitElement {
    render() {
...
IconZoomOut_Outlined.styles = style;
IconZoomOut_Outlined = __decorate([
    customElement('mdui-icon-zoom-out--outlined')
], IconZoomOut_Outlined);
export { IconZoomOut_Outlined };
