...
let IconPsychologyAlt_Outlined = class IconPsychologyAlt_Outlined extends LitElement {
    render() {
...
IconPsychologyAlt_Outlined.styles = style;
IconPsychologyAlt_Outlined = __decorate([
    customElement('mdui-icon-psychology-alt--outlined')
], IconPsychologyAlt_Outlined);
export { IconPsychologyAlt_Outlined };
