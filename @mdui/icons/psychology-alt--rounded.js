...
let IconPsychologyAlt_Rounded = class IconPsychologyAlt_Rounded extends LitElement {
    render() {
...
IconPsychologyAlt_Rounded.styles = style;
IconPsychologyAlt_Rounded = __decorate([
    customElement('mdui-icon-psychology-alt--rounded')
], IconPsychologyAlt_Rounded);
export { IconPsychologyAlt_Rounded };
