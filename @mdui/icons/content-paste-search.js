...
let IconContentPasteSearch = class IconContentPasteSearch extends LitElement {
    render() {
...
IconContentPasteSearch.styles = style;
IconContentPasteSearch = __decorate([
    customElement('mdui-icon-content-paste-search')
