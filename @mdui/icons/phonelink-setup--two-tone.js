...
let IconPhonelinkSetup_TwoTone = class IconPhonelinkSetup_TwoTone extends LitElement {
    render() {
...
IconPhonelinkSetup_TwoTone.styles = style;
IconPhonelinkSetup_TwoTone = __decorate([
    customElement('mdui-icon-phonelink-setup--two-tone')
], IconPhonelinkSetup_TwoTone);
export { IconPhonelinkSetup_TwoTone };
