...
let IconAutoFixOff_Outlined = class IconAutoFixOff_Outlined extends LitElement {
    render() {
...
IconAutoFixOff_Outlined.styles = style;
IconAutoFixOff_Outlined = __decorate([
    customElement('mdui-icon-auto-fix-off--outlined')
], IconAutoFixOff_Outlined);
export { IconAutoFixOff_Outlined };
