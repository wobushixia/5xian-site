...
let IconBluetoothAudio_Rounded = class IconBluetoothAudio_Rounded extends LitElement {
    render() {
...
IconBluetoothAudio_Rounded.styles = style;
IconBluetoothAudio_Rounded = __decorate([
    customElement('mdui-icon-bluetooth-audio--rounded')
], IconBluetoothAudio_Rounded);
export { IconBluetoothAudio_Rounded };
