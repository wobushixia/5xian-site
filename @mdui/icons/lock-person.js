...
let IconLockPerson = class IconLockPerson extends LitElement {
    render() {
...
IconLockPerson.styles = style;
IconLockPerson = __decorate([
    customElement('mdui-icon-lock-person')
], IconLockPerson);
export { IconLockPerson };
