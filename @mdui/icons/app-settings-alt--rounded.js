...
let IconAppSettingsAlt_Rounded = class IconAppSettingsAlt_Rounded extends LitElement {
    render() {
...
IconAppSettingsAlt_Rounded.styles = style;
IconAppSettingsAlt_Rounded = __decorate([
    customElement('mdui-icon-app-settings-alt--rounded')
], IconAppSettingsAlt_Rounded);
export { IconAppSettingsAlt_Rounded };
