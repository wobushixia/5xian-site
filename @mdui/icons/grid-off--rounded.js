...
let IconGridOff_Rounded = class IconGridOff_Rounded extends LitElement {
    render() {
...
IconGridOff_Rounded.styles = style;
IconGridOff_Rounded = __decorate([
    customElement('mdui-icon-grid-off--rounded')
], IconGridOff_Rounded);
export { IconGridOff_Rounded };
