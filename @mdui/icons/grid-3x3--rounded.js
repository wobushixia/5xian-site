...
let IconGrid_3x3_Rounded = class IconGrid_3x3_Rounded extends LitElement {
    render() {
...
IconGrid_3x3_Rounded.styles = style;
IconGrid_3x3_Rounded = __decorate([
    customElement('mdui-icon-grid-3x3--rounded')
], IconGrid_3x3_Rounded);
export { IconGrid_3x3_Rounded };
