...
let IconReduceCapacity_TwoTone = class IconReduceCapacity_TwoTone extends LitElement {
    render() {
...
IconReduceCapacity_TwoTone.styles = style;
IconReduceCapacity_TwoTone = __decorate([
    customElement('mdui-icon-reduce-capacity--two-tone')
], IconReduceCapacity_TwoTone);
export { IconReduceCapacity_TwoTone };
