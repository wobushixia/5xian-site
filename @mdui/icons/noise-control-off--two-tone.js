...
let IconNoiseControlOff_TwoTone = class IconNoiseControlOff_TwoTone extends LitElement {
    render() {
...
IconNoiseControlOff_TwoTone.styles = style;
IconNoiseControlOff_TwoTone = __decorate([
    customElement('mdui-icon-noise-control-off--two-tone')
], IconNoiseControlOff_TwoTone);
export { IconNoiseControlOff_TwoTone };
