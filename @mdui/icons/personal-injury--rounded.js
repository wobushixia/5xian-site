...
let IconPersonalInjury_Rounded = class IconPersonalInjury_Rounded extends LitElement {
    render() {
...
IconPersonalInjury_Rounded.styles = style;
IconPersonalInjury_Rounded = __decorate([
    customElement('mdui-icon-personal-injury--rounded')
], IconPersonalInjury_Rounded);
export { IconPersonalInjury_Rounded };
