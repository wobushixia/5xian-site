...
let IconWifiTetheringOff = class IconWifiTetheringOff extends LitElement {
    render() {
...
IconWifiTetheringOff.styles = style;
IconWifiTetheringOff = __decorate([
    customElement('mdui-icon-wifi-tethering-off')
], IconWifiTetheringOff);
export { IconWifiTetheringOff };
