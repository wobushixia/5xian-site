...
let Icon24mp_Outlined = class Icon24mp_Outlined extends LitElement {
    render() {
...
Icon24mp_Outlined.styles = style;
Icon24mp_Outlined = __decorate([
    customElement('mdui-icon-24mp--outlined')
], Icon24mp_Outlined);
export { Icon24mp_Outlined };
