...
let IconFlipCameraIos_Rounded = class IconFlipCameraIos_Rounded extends LitElement {
    render() {
...
IconFlipCameraIos_Rounded.styles = style;
IconFlipCameraIos_Rounded = __decorate([
    customElement('mdui-icon-flip-camera-ios--rounded')
], IconFlipCameraIos_Rounded);
export { IconFlipCameraIos_Rounded };
