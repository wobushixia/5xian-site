...
let IconDirectionsTransit_Outlined = class IconDirectionsTransit_Outlined extends LitElement {
    render() {
...
IconDirectionsTransit_Outlined.styles = style;
IconDirectionsTransit_Outlined = __decorate([
    customElement('mdui-icon-directions-transit--outlined')
], IconDirectionsTransit_Outlined);
export { IconDirectionsTransit_Outlined };
