...
let IconStreetview_Outlined = class IconStreetview_Outlined extends LitElement {
    render() {
...
IconStreetview_Outlined.styles = style;
IconStreetview_Outlined = __decorate([
    customElement('mdui-icon-streetview--outlined')
], IconStreetview_Outlined);
export { IconStreetview_Outlined };
