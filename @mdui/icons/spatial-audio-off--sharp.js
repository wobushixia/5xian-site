...
let IconSpatialAudioOff_Sharp = class IconSpatialAudioOff_Sharp extends LitElement {
    render() {
...
IconSpatialAudioOff_Sharp.styles = style;
IconSpatialAudioOff_Sharp = __decorate([
    customElement('mdui-icon-spatial-audio-off--sharp')
], IconSpatialAudioOff_Sharp);
export { IconSpatialAudioOff_Sharp };
