...
let IconMenuBook_Outlined = class IconMenuBook_Outlined extends LitElement {
    render() {
...
IconMenuBook_Outlined.styles = style;
IconMenuBook_Outlined = __decorate([
    customElement('mdui-icon-menu-book--outlined')
], IconMenuBook_Outlined);
export { IconMenuBook_Outlined };
