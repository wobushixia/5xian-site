...
let IconManageHistory_TwoTone = class IconManageHistory_TwoTone extends LitElement {
    render() {
...
IconManageHistory_TwoTone.styles = style;
IconManageHistory_TwoTone = __decorate([
    customElement('mdui-icon-manage-history--two-tone')
], IconManageHistory_TwoTone);
export { IconManageHistory_TwoTone };
