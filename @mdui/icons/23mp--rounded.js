...
let Icon23mp_Rounded = class Icon23mp_Rounded extends LitElement {
    render() {
...
Icon23mp_Rounded.styles = style;
Icon23mp_Rounded = __decorate([
    customElement('mdui-icon-23mp--rounded')
], Icon23mp_Rounded);
export { Icon23mp_Rounded };
