...
let IconYoutubeSearchedFor = class IconYoutubeSearchedFor extends LitElement {
    render() {
...
IconYoutubeSearchedFor.styles = style;
IconYoutubeSearchedFor = __decorate([
    customElement('mdui-icon-youtube-searched-for')
