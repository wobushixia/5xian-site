...
let IconMediation_Sharp = class IconMediation_Sharp extends LitElement {
    render() {
...
IconMediation_Sharp.styles = style;
IconMediation_Sharp = __decorate([
    customElement('mdui-icon-mediation--sharp')
], IconMediation_Sharp);
export { IconMediation_Sharp };
