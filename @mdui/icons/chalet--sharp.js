...
let IconChalet_Sharp = class IconChalet_Sharp extends LitElement {
    render() {
...
IconChalet_Sharp.styles = style;
IconChalet_Sharp = __decorate([
    customElement('mdui-icon-chalet--sharp')
], IconChalet_Sharp);
export { IconChalet_Sharp };
