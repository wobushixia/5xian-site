...
let IconSoap_TwoTone = class IconSoap_TwoTone extends LitElement {
    render() {
...
IconSoap_TwoTone.styles = style;
IconSoap_TwoTone = __decorate([
    customElement('mdui-icon-soap--two-tone')
], IconSoap_TwoTone);
export { IconSoap_TwoTone };
