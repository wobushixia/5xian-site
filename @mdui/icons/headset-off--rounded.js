...
let IconHeadsetOff_Rounded = class IconHeadsetOff_Rounded extends LitElement {
    render() {
...
IconHeadsetOff_Rounded.styles = style;
IconHeadsetOff_Rounded = __decorate([
    customElement('mdui-icon-headset-off--rounded')
], IconHeadsetOff_Rounded);
export { IconHeadsetOff_Rounded };
