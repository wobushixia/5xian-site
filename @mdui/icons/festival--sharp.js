...
let IconFestival_Sharp = class IconFestival_Sharp extends LitElement {
    render() {
...
IconFestival_Sharp.styles = style;
IconFestival_Sharp = __decorate([
    customElement('mdui-icon-festival--sharp')
], IconFestival_Sharp);
export { IconFestival_Sharp };
