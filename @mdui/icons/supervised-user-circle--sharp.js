...
let IconSupervisedUserCircle_Sharp = class IconSupervisedUserCircle_Sharp extends LitElement {
    render() {
...
IconSupervisedUserCircle_Sharp.styles = style;
IconSupervisedUserCircle_Sharp = __decorate([
    customElement('mdui-icon-supervised-user-circle--sharp')
], IconSupervisedUserCircle_Sharp);
export { IconSupervisedUserCircle_Sharp };
