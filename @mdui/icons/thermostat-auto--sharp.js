...
let IconThermostatAuto_Sharp = class IconThermostatAuto_Sharp extends LitElement {
    render() {
...
IconThermostatAuto_Sharp.styles = style;
IconThermostatAuto_Sharp = __decorate([
    customElement('mdui-icon-thermostat-auto--sharp')
], IconThermostatAuto_Sharp);
export { IconThermostatAuto_Sharp };
