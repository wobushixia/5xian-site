...
let Icon3dRotation_Sharp = class Icon3dRotation_Sharp extends LitElement {
    render() {
...
Icon3dRotation_Sharp.styles = style;
Icon3dRotation_Sharp = __decorate([
    customElement('mdui-icon-3d-rotation--sharp')
], Icon3dRotation_Sharp);
export { Icon3dRotation_Sharp };
