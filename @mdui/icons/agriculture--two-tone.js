...
let IconAgriculture_TwoTone = class IconAgriculture_TwoTone extends LitElement {
    render() {
...
IconAgriculture_TwoTone.styles = style;
IconAgriculture_TwoTone = __decorate([
    customElement('mdui-icon-agriculture--two-tone')
], IconAgriculture_TwoTone);
export { IconAgriculture_TwoTone };
