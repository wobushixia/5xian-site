...
let IconSportsBasketball_Outlined = class IconSportsBasketball_Outlined extends LitElement {
    render() {
...
IconSportsBasketball_Outlined.styles = style;
IconSportsBasketball_Outlined = __decorate([
    customElement('mdui-icon-sports-basketball--outlined')
], IconSportsBasketball_Outlined);
export { IconSportsBasketball_Outlined };
