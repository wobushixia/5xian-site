...
let IconSnowshoeing_Rounded = class IconSnowshoeing_Rounded extends LitElement {
    render() {
...
IconSnowshoeing_Rounded.styles = style;
IconSnowshoeing_Rounded = __decorate([
    customElement('mdui-icon-snowshoeing--rounded')
], IconSnowshoeing_Rounded);
export { IconSnowshoeing_Rounded };
