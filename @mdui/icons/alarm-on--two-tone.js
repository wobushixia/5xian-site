...
let IconAlarmOn_TwoTone = class IconAlarmOn_TwoTone extends LitElement {
    render() {
...
IconAlarmOn_TwoTone.styles = style;
IconAlarmOn_TwoTone = __decorate([
    customElement('mdui-icon-alarm-on--two-tone')
], IconAlarmOn_TwoTone);
export { IconAlarmOn_TwoTone };
