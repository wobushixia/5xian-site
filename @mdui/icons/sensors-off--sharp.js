...
let IconSensorsOff_Sharp = class IconSensorsOff_Sharp extends LitElement {
    render() {
...
IconSensorsOff_Sharp.styles = style;
IconSensorsOff_Sharp = __decorate([
    customElement('mdui-icon-sensors-off--sharp')
], IconSensorsOff_Sharp);
export { IconSensorsOff_Sharp };
