...
let IconAppSettingsAlt_Sharp = class IconAppSettingsAlt_Sharp extends LitElement {
    render() {
...
IconAppSettingsAlt_Sharp.styles = style;
IconAppSettingsAlt_Sharp = __decorate([
    customElement('mdui-icon-app-settings-alt--sharp')
], IconAppSettingsAlt_Sharp);
export { IconAppSettingsAlt_Sharp };
