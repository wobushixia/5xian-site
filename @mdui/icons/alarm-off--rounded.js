...
let IconAlarmOff_Rounded = class IconAlarmOff_Rounded extends LitElement {
    render() {
...
IconAlarmOff_Rounded.styles = style;
IconAlarmOff_Rounded = __decorate([
    customElement('mdui-icon-alarm-off--rounded')
], IconAlarmOff_Rounded);
export { IconAlarmOff_Rounded };
