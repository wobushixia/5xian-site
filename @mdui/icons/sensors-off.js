...
let IconSensorsOff = class IconSensorsOff extends LitElement {
    render() {
...
IconSensorsOff.styles = style;
IconSensorsOff = __decorate([
    customElement('mdui-icon-sensors-off')
], IconSensorsOff);
export { IconSensorsOff };
