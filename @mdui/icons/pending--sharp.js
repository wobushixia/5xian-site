...
let IconPending_Sharp = class IconPending_Sharp extends LitElement {
    render() {
...
IconPending_Sharp.styles = style;
IconPending_Sharp = __decorate([
    customElement('mdui-icon-pending--sharp')
], IconPending_Sharp);
export { IconPending_Sharp };
