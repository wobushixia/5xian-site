...
let IconForest_TwoTone = class IconForest_TwoTone extends LitElement {
    render() {
...
IconForest_TwoTone.styles = style;
IconForest_TwoTone = __decorate([
    customElement('mdui-icon-forest--two-tone')
], IconForest_TwoTone);
export { IconForest_TwoTone };
