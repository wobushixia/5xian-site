...
let IconSupport_Outlined = class IconSupport_Outlined extends LitElement {
    render() {
...
IconSupport_Outlined.styles = style;
IconSupport_Outlined = __decorate([
    customElement('mdui-icon-support--outlined')
], IconSupport_Outlined);
export { IconSupport_Outlined };
