...
let IconPanToolAlt_Outlined = class IconPanToolAlt_Outlined extends LitElement {
    render() {
...
IconPanToolAlt_Outlined.styles = style;
IconPanToolAlt_Outlined = __decorate([
    customElement('mdui-icon-pan-tool-alt--outlined')
], IconPanToolAlt_Outlined);
export { IconPanToolAlt_Outlined };
