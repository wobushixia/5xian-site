...
let IconSyncProblem = class IconSyncProblem extends LitElement {
    render() {
...
IconSyncProblem.styles = style;
IconSyncProblem = __decorate([
    customElement('mdui-icon-sync-problem')
], IconSyncProblem);
