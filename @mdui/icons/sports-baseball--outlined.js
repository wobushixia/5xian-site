...
let IconSportsBaseball_Outlined = class IconSportsBaseball_Outlined extends LitElement {
    render() {
...
IconSportsBaseball_Outlined.styles = style;
IconSportsBaseball_Outlined = __decorate([
    customElement('mdui-icon-sports-baseball--outlined')
], IconSportsBaseball_Outlined);
export { IconSportsBaseball_Outlined };
