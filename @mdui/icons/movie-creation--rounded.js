...
let IconMovieCreation_Rounded = class IconMovieCreation_Rounded extends LitElement {
    render() {
...
IconMovieCreation_Rounded.styles = style;
IconMovieCreation_Rounded = __decorate([
    customElement('mdui-icon-movie-creation--rounded')
], IconMovieCreation_Rounded);
export { IconMovieCreation_Rounded };
