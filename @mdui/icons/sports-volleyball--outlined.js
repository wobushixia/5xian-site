...
let IconSportsVolleyball_Outlined = class IconSportsVolleyball_Outlined extends LitElement {
    render() {
...
IconSportsVolleyball_Outlined.styles = style;
IconSportsVolleyball_Outlined = __decorate([
    customElement('mdui-icon-sports-volleyball--outlined')
], IconSportsVolleyball_Outlined);
export { IconSportsVolleyball_Outlined };
