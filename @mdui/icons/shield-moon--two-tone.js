...
let IconShieldMoon_TwoTone = class IconShieldMoon_TwoTone extends LitElement {
    render() {
...
IconShieldMoon_TwoTone.styles = style;
IconShieldMoon_TwoTone = __decorate([
    customElement('mdui-icon-shield-moon--two-tone')
], IconShieldMoon_TwoTone);
export { IconShieldMoon_TwoTone };
