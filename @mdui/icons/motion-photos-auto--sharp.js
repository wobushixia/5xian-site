...
let IconMotionPhotosAuto_Sharp = class IconMotionPhotosAuto_Sharp extends LitElement {
    render() {
...
IconMotionPhotosAuto_Sharp.styles = style;
IconMotionPhotosAuto_Sharp = __decorate([
    customElement('mdui-icon-motion-photos-auto--sharp')
], IconMotionPhotosAuto_Sharp);
export { IconMotionPhotosAuto_Sharp };
