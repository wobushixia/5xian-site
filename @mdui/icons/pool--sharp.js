...
let IconPool_Sharp = class IconPool_Sharp extends LitElement {
    render() {
...
IconPool_Sharp.styles = style;
IconPool_Sharp = __decorate([
    customElement('mdui-icon-pool--sharp')
], IconPool_Sharp);
export { IconPool_Sharp };
