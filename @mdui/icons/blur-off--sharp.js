...
let IconBlurOff_Sharp = class IconBlurOff_Sharp extends LitElement {
    render() {
...
IconBlurOff_Sharp.styles = style;
IconBlurOff_Sharp = __decorate([
    customElement('mdui-icon-blur-off--sharp')
], IconBlurOff_Sharp);
export { IconBlurOff_Sharp };
