...
let IconPointOfSale = class IconPointOfSale extends LitElement {
    render() {
...
IconPointOfSale.styles = style;
IconPointOfSale = __decorate([
    customElement('mdui-icon-point-of-sale')
], IconPointOfSale);
