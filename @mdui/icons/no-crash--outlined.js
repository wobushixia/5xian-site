...
let IconNoCrash_Outlined = class IconNoCrash_Outlined extends LitElement {
    render() {
...
IconNoCrash_Outlined.styles = style;
IconNoCrash_Outlined = __decorate([
    customElement('mdui-icon-no-crash--outlined')
], IconNoCrash_Outlined);
export { IconNoCrash_Outlined };
