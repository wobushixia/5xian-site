...
let IconElderlyWoman = class IconElderlyWoman extends LitElement {
    render() {
...
IconElderlyWoman.styles = style;
IconElderlyWoman = __decorate([
    customElement('mdui-icon-elderly-woman')
], IconElderlyWoman);
