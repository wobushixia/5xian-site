...
let IconVapeFree_Sharp = class IconVapeFree_Sharp extends LitElement {
    render() {
...
IconVapeFree_Sharp.styles = style;
IconVapeFree_Sharp = __decorate([
    customElement('mdui-icon-vape-free--sharp')
], IconVapeFree_Sharp);
export { IconVapeFree_Sharp };
