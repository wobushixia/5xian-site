...
let IconOutdoorGrill_Sharp = class IconOutdoorGrill_Sharp extends LitElement {
    render() {
...
IconOutdoorGrill_Sharp.styles = style;
IconOutdoorGrill_Sharp = __decorate([
    customElement('mdui-icon-outdoor-grill--sharp')
], IconOutdoorGrill_Sharp);
export { IconOutdoorGrill_Sharp };
