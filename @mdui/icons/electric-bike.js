...
let IconElectricBike = class IconElectricBike extends LitElement {
    render() {
...
IconElectricBike.styles = style;
IconElectricBike = __decorate([
    customElement('mdui-icon-electric-bike')
], IconElectricBike);
