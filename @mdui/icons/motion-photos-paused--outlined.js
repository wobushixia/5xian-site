...
let IconMotionPhotosPaused_Outlined = class IconMotionPhotosPaused_Outlined extends LitElement {
    render() {
...
IconMotionPhotosPaused_Outlined.styles = style;
IconMotionPhotosPaused_Outlined = __decorate([
    customElement('mdui-icon-motion-photos-paused--outlined')
], IconMotionPhotosPaused_Outlined);
export { IconMotionPhotosPaused_Outlined };
