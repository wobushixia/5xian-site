...
let IconEuro_TwoTone = class IconEuro_TwoTone extends LitElement {
    render() {
...
IconEuro_TwoTone.styles = style;
IconEuro_TwoTone = __decorate([
    customElement('mdui-icon-euro--two-tone')
], IconEuro_TwoTone);
export { IconEuro_TwoTone };
