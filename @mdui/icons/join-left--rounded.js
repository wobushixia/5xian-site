...
let IconJoinLeft_Rounded = class IconJoinLeft_Rounded extends LitElement {
    render() {
...
IconJoinLeft_Rounded.styles = style;
IconJoinLeft_Rounded = __decorate([
    customElement('mdui-icon-join-left--rounded')
], IconJoinLeft_Rounded);
export { IconJoinLeft_Rounded };
