...
let IconDryCleaning_Rounded = class IconDryCleaning_Rounded extends LitElement {
    render() {
...
IconDryCleaning_Rounded.styles = style;
IconDryCleaning_Rounded = __decorate([
    customElement('mdui-icon-dry-cleaning--rounded')
], IconDryCleaning_Rounded);
export { IconDryCleaning_Rounded };
