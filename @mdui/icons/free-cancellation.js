...
let IconFreeCancellation = class IconFreeCancellation extends LitElement {
    render() {
...
IconFreeCancellation.styles = style;
IconFreeCancellation = __decorate([
    customElement('mdui-icon-free-cancellation')
