...
let IconGroups_3_Sharp = class IconGroups_3_Sharp extends LitElement {
    render() {
...
IconGroups_3_Sharp.styles = style;
IconGroups_3_Sharp = __decorate([
    customElement('mdui-icon-groups-3--sharp')
], IconGroups_3_Sharp);
export { IconGroups_3_Sharp };
