...
let IconSportsHockey = class IconSportsHockey extends LitElement {
    render() {
...
IconSportsHockey.styles = style;
IconSportsHockey = __decorate([
    customElement('mdui-icon-sports-hockey')
], IconSportsHockey);
