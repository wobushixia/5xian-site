...
let IconPestControl_Rounded = class IconPestControl_Rounded extends LitElement {
    render() {
...
IconPestControl_Rounded.styles = style;
IconPestControl_Rounded = __decorate([
    customElement('mdui-icon-pest-control--rounded')
], IconPestControl_Rounded);
export { IconPestControl_Rounded };
