...
let IconFaceRetouchingOff_Outlined = class IconFaceRetouchingOff_Outlined extends LitElement {
    render() {
...
IconFaceRetouchingOff_Outlined.styles = style;
IconFaceRetouchingOff_Outlined = __decorate([
    customElement('mdui-icon-face-retouching-off--outlined')
], IconFaceRetouchingOff_Outlined);
export { IconFaceRetouchingOff_Outlined };
