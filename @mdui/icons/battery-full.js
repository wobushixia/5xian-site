...
let IconBatteryFull = class IconBatteryFull extends LitElement {
    render() {
...
IconBatteryFull.styles = style;
IconBatteryFull = __decorate([
    customElement('mdui-icon-battery-full')
], IconBatteryFull);
