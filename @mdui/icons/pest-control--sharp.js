...
let IconPestControl_Sharp = class IconPestControl_Sharp extends LitElement {
    render() {
...
IconPestControl_Sharp.styles = style;
IconPestControl_Sharp = __decorate([
    customElement('mdui-icon-pest-control--sharp')
], IconPestControl_Sharp);
export { IconPestControl_Sharp };
