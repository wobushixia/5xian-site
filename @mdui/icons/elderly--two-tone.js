...
let IconElderly_TwoTone = class IconElderly_TwoTone extends LitElement {
    render() {
...
IconElderly_TwoTone.styles = style;
IconElderly_TwoTone = __decorate([
    customElement('mdui-icon-elderly--two-tone')
], IconElderly_TwoTone);
export { IconElderly_TwoTone };
