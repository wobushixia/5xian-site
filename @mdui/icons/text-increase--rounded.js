...
let IconTextIncrease_Rounded = class IconTextIncrease_Rounded extends LitElement {
    render() {
...
IconTextIncrease_Rounded.styles = style;
IconTextIncrease_Rounded = __decorate([
    customElement('mdui-icon-text-increase--rounded')
], IconTextIncrease_Rounded);
export { IconTextIncrease_Rounded };
