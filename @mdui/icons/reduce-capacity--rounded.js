...
let IconReduceCapacity_Rounded = class IconReduceCapacity_Rounded extends LitElement {
    render() {
...
IconReduceCapacity_Rounded.styles = style;
IconReduceCapacity_Rounded = __decorate([
    customElement('mdui-icon-reduce-capacity--rounded')
], IconReduceCapacity_Rounded);
export { IconReduceCapacity_Rounded };
