...
let IconPsychology_Sharp = class IconPsychology_Sharp extends LitElement {
    render() {
...
IconPsychology_Sharp.styles = style;
IconPsychology_Sharp = __decorate([
    customElement('mdui-icon-psychology--sharp')
], IconPsychology_Sharp);
export { IconPsychology_Sharp };
