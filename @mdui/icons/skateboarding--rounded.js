...
let IconSkateboarding_Rounded = class IconSkateboarding_Rounded extends LitElement {
    render() {
...
IconSkateboarding_Rounded.styles = style;
IconSkateboarding_Rounded = __decorate([
    customElement('mdui-icon-skateboarding--rounded')
], IconSkateboarding_Rounded);
export { IconSkateboarding_Rounded };
