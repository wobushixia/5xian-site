...
let IconSwipeLeft_TwoTone = class IconSwipeLeft_TwoTone extends LitElement {
    render() {
...
IconSwipeLeft_TwoTone.styles = style;
IconSwipeLeft_TwoTone = __decorate([
    customElement('mdui-icon-swipe-left--two-tone')
], IconSwipeLeft_TwoTone);
export { IconSwipeLeft_TwoTone };
