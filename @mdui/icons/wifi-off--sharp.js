...
let IconWifiOff_Sharp = class IconWifiOff_Sharp extends LitElement {
    render() {
...
IconWifiOff_Sharp.styles = style;
IconWifiOff_Sharp = __decorate([
    customElement('mdui-icon-wifi-off--sharp')
], IconWifiOff_Sharp);
export { IconWifiOff_Sharp };
