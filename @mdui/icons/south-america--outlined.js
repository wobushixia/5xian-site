...
let IconSouthAmerica_Outlined = class IconSouthAmerica_Outlined extends LitElement {
    render() {
...
IconSouthAmerica_Outlined.styles = style;
IconSouthAmerica_Outlined = __decorate([
    customElement('mdui-icon-south-america--outlined')
], IconSouthAmerica_Outlined);
export { IconSouthAmerica_Outlined };
