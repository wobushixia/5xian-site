...
let IconAnimation_Sharp = class IconAnimation_Sharp extends LitElement {
    render() {
...
IconAnimation_Sharp.styles = style;
IconAnimation_Sharp = __decorate([
    customElement('mdui-icon-animation--sharp')
], IconAnimation_Sharp);
export { IconAnimation_Sharp };
