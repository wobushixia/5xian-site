...
let IconBrightness_6_Rounded = class IconBrightness_6_Rounded extends LitElement {
    render() {
...
IconBrightness_6_Rounded.styles = style;
IconBrightness_6_Rounded = __decorate([
    customElement('mdui-icon-brightness-6--rounded')
], IconBrightness_6_Rounded);
export { IconBrightness_6_Rounded };
