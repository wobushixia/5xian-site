...
let IconBusAlert_Rounded = class IconBusAlert_Rounded extends LitElement {
    render() {
...
IconBusAlert_Rounded.styles = style;
IconBusAlert_Rounded = __decorate([
    customElement('mdui-icon-bus-alert--rounded')
], IconBusAlert_Rounded);
export { IconBusAlert_Rounded };
