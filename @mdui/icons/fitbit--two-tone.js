...
let IconFitbit_TwoTone = class IconFitbit_TwoTone extends LitElement {
    render() {
...
IconFitbit_TwoTone.styles = style;
IconFitbit_TwoTone = __decorate([
    customElement('mdui-icon-fitbit--two-tone')
], IconFitbit_TwoTone);
export { IconFitbit_TwoTone };
