...
let IconTimer_10_Sharp = class IconTimer_10_Sharp extends LitElement {
    render() {
...
IconTimer_10_Sharp.styles = style;
IconTimer_10_Sharp = __decorate([
    customElement('mdui-icon-timer-10--sharp')
], IconTimer_10_Sharp);
export { IconTimer_10_Sharp };
