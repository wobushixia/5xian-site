...
let IconDiversity_2 = class IconDiversity_2 extends LitElement {
    render() {
...
IconDiversity_2.styles = style;
IconDiversity_2 = __decorate([
    customElement('mdui-icon-diversity-2')
], IconDiversity_2);
export { IconDiversity_2 };
