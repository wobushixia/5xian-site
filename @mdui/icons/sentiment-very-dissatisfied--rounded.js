...
let IconSentimentVeryDissatisfied_Rounded = class IconSentimentVeryDissatisfied_Rounded extends LitElement {
    render() {
...
IconSentimentVeryDissatisfied_Rounded.styles = style;
IconSentimentVeryDissatisfied_Rounded = __decorate([
    customElement('mdui-icon-sentiment-very-dissatisfied--rounded')
], IconSentimentVeryDissatisfied_Rounded);
export { IconSentimentVeryDissatisfied_Rounded };
