...
let IconSatelliteAlt = class IconSatelliteAlt extends LitElement {
    render() {
...
IconSatelliteAlt.styles = style;
IconSatelliteAlt = __decorate([
    customElement('mdui-icon-satellite-alt')
], IconSatelliteAlt);
export { IconSatelliteAlt };
