...
let IconNoiseAware_TwoTone = class IconNoiseAware_TwoTone extends LitElement {
    render() {
...
IconNoiseAware_TwoTone.styles = style;
IconNoiseAware_TwoTone = __decorate([
    customElement('mdui-icon-noise-aware--two-tone')
], IconNoiseAware_TwoTone);
export { IconNoiseAware_TwoTone };
