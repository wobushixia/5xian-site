...
let IconHearingDisabled_TwoTone = class IconHearingDisabled_TwoTone extends LitElement {
    render() {
...
IconHearingDisabled_TwoTone.styles = style;
IconHearingDisabled_TwoTone = __decorate([
    customElement('mdui-icon-hearing-disabled--two-tone')
], IconHearingDisabled_TwoTone);
export { IconHearingDisabled_TwoTone };
