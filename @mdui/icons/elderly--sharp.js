...
let IconElderly_Sharp = class IconElderly_Sharp extends LitElement {
    render() {
...
IconElderly_Sharp.styles = style;
IconElderly_Sharp = __decorate([
    customElement('mdui-icon-elderly--sharp')
], IconElderly_Sharp);
export { IconElderly_Sharp };
